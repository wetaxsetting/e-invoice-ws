...
namespace EInvoice.Company
{
    public class Solution
    {
        public static string View(string tei_einvoice_m_pk, string tei_company_pk, string dbName)
        {
            ...
            htmlStr.Append("  <td width=32 class=xl66 style='width:30pt;border-top:1.0pt solid windowtext;' align=left valign=top><!--[if gte vml 1]><v:shapetype                                                                                          \n");
            htmlStr.Append("   id='_x0000_t75' coordsize='21600,21600' o:spt='75' o:preferrelative='t'                                                                                                       \n");
            htmlStr.Append("   path='m@4@5l@4@11@9@11@9@5xe' filled='f' stroked='f'>                                                                                                                         \n");
            htmlStr.Append("   <v:stroke joinstyle='miter'/>                                                                                                                                                 \n");
            htmlStr.Append("   <v:formulas>                                                                                                                                                                  \n");
            htmlStr.Append("    <v:f eqn='if lineDrawn pixelLineWidth 0'/>                                                                                                                                   \n");
            htmlStr.Append("    <v:f eqn='sum @0 1 0'/>                                                                                                                                                      \n");
            htmlStr.Append("    <v:f eqn='sum 0 0 @1'/>                                                                                                                                                      \n");
            htmlStr.Append("    <v:f eqn='prod @2 1 2'/>                                                                                                                                                     \n");
            htmlStr.Append("    <v:f eqn='prod @3 21600 pixelWidth'/>                                                                                                                                        \n");
            htmlStr.Append("    <v:f eqn='prod @3 21600 pixelHeight'/>                                                                                                                                       \n");
            htmlStr.Append("    <v:f eqn='sum @0 0 1'/>                                                                                                                                                      \n");
            htmlStr.Append("    <v:f eqn='prod @6 1 2'/>                                                                                                                                                     \n");
            htmlStr.Append("    <v:f eqn='prod @7 21600 pixelWidth'/>                                                                                                                                        \n");
            htmlStr.Append("    <v:f eqn='sum @8 21600 0'/>                                                                                                                                                  \n");
            htmlStr.Append("    <v:f eqn='prod @7 21600 pixelHeight'/>                                                                                                                                       \n");
            htmlStr.Append("    <v:f eqn='sum @10 21600 0'/>                                                                                                                                                 \n");
            htmlStr.Append("   </v:formulas>                                                                                                                                                                 \n");
            htmlStr.Append("   <v:path o:extrusionok='f' gradientshapeok='t' o:connecttype='rect'/>                                                                                                          \n");
            htmlStr.Append("   <o:lock v:ext='edit' aspectratio='t'/>                                                                                                                                        \n");
            htmlStr.Append("  </v:shapetype><v:shape id='Picture_x0020_1' o:spid='_x0000_s1025' type='#_x0000_t75'                                                                                           \n");
            htmlStr.Append("   style='position:absolute;margin-left:.75pt;margin-top:10.5pt;width:138pt;                                                                                                     \n");
            htmlStr.Append("   height:65.25pt;z-index:1;visibility:visible'>                                                                                                                                 \n");
            htmlStr.Append("   <v:imagedata src='hdsolution_files/image001.png' o:title=''/>                                                                                                                 \n");
            htmlStr.Append("   <x:ClientData ObjectType='Pict'>                                                                                                                                              \n");
            htmlStr.Append("    <x:SizeWithCells/>                                                                                                                                                           \n");
            htmlStr.Append("    <x:CF>Bitmap</x:CF>                                                                                                                                                          \n");
            htmlStr.Append("   </x:ClientData>                                                                                                                                                               \n");
            htmlStr.Append("  </v:shape><![endif]--><![if !vml]><span style='mso-ignore:vglayout;                                                                                                            \n");
            htmlStr.Append("  position:absolute;z-index:1;margin-left:1px;margin-top:14px;width:230px;                                                                                                       \n");
            htmlStr.Append("  height:108px'><img width=230 height=87 src='E:/webproject/E_INVOICE_WS/02.Web/EInvoice/img/Solution.jpg'                                                                             \n");
            ...
            htmlStr.Append("  <td colspan=2 class=xl203>Mẫu số : <font class='font28'>" + dt.Rows[0]["templateCode"] + " </font></td>                                                                                            \n");
            htmlStr.Append("  <td class=xl76>&nbsp;</td>                                                                                                                                                     \n");
            htmlStr.Append(" </tr>                                                                                                                                                                           \n");
            ...
            htmlStr.Append("  width=891 height=357 src='E:/webproject/E_INVOICE_WS/02.Web/EInvoice/img/solutionbg2.png' v:shapes='Rectangle_x0020_1'></span><![endif]>                                            \n");
            htmlStr.Append("  </td>                                                                                                                                                                          \n");
            htmlStr.Append(" </tr>                                                                                                                                                                           \n");
            ...
            htmlStr.Append("  <td colspan=5 class=xl178 width=312 style='border-right:1.0pt solid #0066CC;                                                                                                    \n");
            ...
            htmlStr.Append("  <td height=36 class=xl71 style='height:27.0pt'>&nbsp;Mã nh&#7853;n hóa &#273;&#417;n:  <font style='color: #003366;font-weight: 400;font-family:'Times New Roman', serif;font-size: 12pt'>&nbsp;&nbsp;" + dt.Rows[0]["matracuu"] + "</font></td>                                                                                                                     \n");
            htmlStr.Append("  <td colspan=2 class=xl181></td>                                                                                                                                                \n");
            htmlStr.Append("  <td colspan=3 class=xl170 style='mso-ignore:colspan'></td>                                                                                                                     \n");
            htmlStr.Append("  <td colspan=5 class=xl182 width=312 style='border-right:1.0pt solid #0066CC;                                                                                                    \n");
            ...
            htmlStr.Append("  <td colspan=5 class=xl173 style='border-right:1.0pt solid #0066CC'><font                                                                                                        \n");
            ...
            htmlStr.Append(" </tr>                                                                                                                                                                           \n");
            htmlStr.Append(" <tr height=20 style='mso-height-source:userset;height:18.75pt'>                                                                                                                  \n");
            htmlStr.Append("  <td height=20 colspan=2 class=xl72 style='height:18.75pt;mso-ignore:colspan'></td>                                                                                              \n");
