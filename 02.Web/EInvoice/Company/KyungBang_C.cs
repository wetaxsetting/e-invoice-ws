    ...
    public class KyungBang_C
    {
        public static string View(string tei_einvoice_m_pk, string tei_company_pk,string dbName)
        {
           ...
           // htmlStr.Append("<link rel='stylesheet' href='https://cdnjs.cloudflare.com/ajax/libs/paper-css/0.2.3/paper.css'>                                                           \n");
            ...
            htmlStr.Append("  src='E:/webproject/E_INVOICE_WS/02.Web/EInvoice/img/KyungBang_01.png'                                                                                \n");
            ...
            htmlStr.Append(" <tr height=24 style='mso-height-source:userset;height:21.25pt'>                                                                                          \n");
            htmlStr.Append("  <td height=24 class=xl12611323 style='height:21.25pt'>&nbsp;</td>                                                                                       \n");
            htmlStr.Append("  <td class=xl7611323 colspan=15>&#272;i&#7879;n tho&#7841;i <font class='font1211323'>(Tel)</font>: " + dt.Rows[0]["Seller_Tel"] + " - Fax: " + dt.Rows[0]["Seller_Fax"] + "</td> \n");
            htmlStr.Append("                                                                                                                                                         \n");
            htmlStr.Append("  <td class=xl7111323>&nbsp;</td>                                                                                                                        \n");
            htmlStr.Append(" </tr>                                                                                                                                                   \n");
            htmlStr.Append(" <tr height=24 style='mso-height-source:userset;height:21.25pt'>                                                                                          \n");
            ...
            htmlStr.Append("  </font>" + dt.Rows[0]["seller_accountno"] + "</td>                                                                                                                       \n");
            htmlStr.Append("  <td class=xl7111323>&nbsp;</td>                                                                                                                        \n");
            htmlStr.Append(" </tr>                                                                                                                                                   \n");
            htmlStr.Append(" <tr height=24 style='mso-height-source:userset;height:22.5pt'>                                                                                          \n");
            htmlStr.Append("  <td height=24 class=xl12611323 style='height:22.5pt'>&nbsp;</td>                                                                                       \n");
            ...
            htmlStr.Append("  </font>" + dt.Rows[0]["seller_accountno2"] + "</td>                                                                                                                     \n");
            htmlStr.Append("  <td class=xl7111323>&nbsp;</td>                                                                                                                        \n");
            htmlStr.Append(" </tr>                                                                                                                                                   \n");
            htmlStr.Append(" <tr height=24 style='mso-height-source:userset;height:21.25pt'>                                                                                          \n");
            htmlStr.Append("  <td height=24 class=xl12611323 style='height:21.25pt;border-top:1pt solid black'>&nbsp;</td>                                                           \n");
            ...
            for (int dtR = 0; dtR < v_count; dtR++)
            {
                ...
                if (dtR == 0)
                {
                    ...
                    htmlStr.Append("							  src='E:/webproject/E_INVOICE_WS/02.Web/EInvoice/img/KyungBang_05.png' style='background: none;'                                                    \n");
            ...
            htmlStr.Append("  <td colspan = 4 class=xl16811323 width = 196 style='width:148pt'>Converter</td>                                                                         \n");
            ...
            htmlStr.Append("  src='E:/webproject/E_INVOICE_WS/02.Web/EInvoice/img/check_signed.png'                                                                                   \n");
            ...
            htmlStr.Append("  class='font1911323'>http://genuwinsolution.com/e-invoice</font></td>                                                                                   \n");
            ...
            htmlStr.Append("  <td class=xl10011323 width=6 style='width:5pt'>&nbsp;</td>                                                                                             \n");
            htmlStr.Append(" </tr>                                                                                                                                                   \n");
            htmlStr.Append(" <tr height=16 style='mso-height-source:userset;height:18.75pt'>                                                                                          \n");
            htmlStr.Append("  <td height=16 class=xl12611323 style='height:18.75pt'>&nbsp;</td>                                                                                       \n");
            htmlStr.Append("  <td colspan=15 class=xl17011323>(C&#7847;n ki&#7875;m tra, &#273;&#7889;i                                                                              \n");
            htmlStr.Append("  chi&#7871;u khi l&#7853;p, giao nh&#7853;n hóa &#273;&#417;n)</td>                                                                                     \n");
            htmlStr.Append("  <td class=xl10011323 width=6 style='width:5pt'>&nbsp;</td>                                                                                             \n");
            htmlStr.Append(" </tr>                                                                                                                                                   \n");
            htmlStr.Append(" <tr height=16 style='mso-height-source:userset;height:18.75pt'>                                                                                          \n");
            htmlStr.Append("  <td height=16 class=xl8311323 style='height:18.75pt'>&nbsp;</td>                                                                                        \n");
            htmlStr.Append("  <td colspan=15 class=xl17511323>(In t&#7841;i ph&#7847;n m&#7873;m Genuwin                                                                             \n");
            htmlStr.Append("  E-INVOICE c&#7911;a Công ty TNHH MTV GENUWIN SOLUTION - MST: 1201496252)</td>                                                                          \n");
