    ...
    public class HiKnit_C_New
    {
        public static string View(string tei_einvoice_m_pk, string tei_company_pk, string dbName)
        {
            ...
            for (int k = 0; k < v_countNumberOfPages; k++)
            {
                ...
                htmlStr.Append("      <td class=xl6822200>&nbsp;</td>                                                               \n");
                htmlStr.Append("      <td class=xl6822200>&nbsp;</td>                                                               \n");
                htmlStr.Append("      <td class=xl8622200 colspan=6><span                                                               \n");
                htmlStr.Append("      style='mso-spacerun:yes'> </span><font                                                               \n");
                htmlStr.Append("      class='font922200'>" + dt.Rows[0]["Seller_Accountno2"] + " <span style='mso-spacerun:yes'>  </span></font></td>                                                               \n");
                htmlStr.Append("      <td class=xl11022200>&nbsp;</td>                                                               \n");
                htmlStr.Append("      <td class=xl11022200>&nbsp;</td>                                                               \n");
                htmlStr.Append("      <td class=xl11122200>&nbsp;</td>                                                               \n");
                htmlStr.Append("      <td class=xl11122200>&nbsp;</td>                                                               \n");
                ...
                htmlStr.Append("					<td class=xl6622200>&nbsp;</td>                                                                                          \n");
                htmlStr.Append("					<td class=xl6622200>&nbsp;</td>                                                                                          \n");
                htmlStr.Append("					<td colspan=10 class=xl13422200>(HÓA &#272;&#416;N CHUY&#7874;N &#272;&#7892;I T&#7914; HÓA &#272;&#416;N &#272;I&#7878;N T&#7916;)</td>                                                                                    \n");
                ...
                for (int dtR = 0; dtR < page[k]; dtR++)
                {
                    ...
                    else if (dtR == page[k] - 1)//dong cuoi moi trang
                    {
                        if (k < v_countNumberOfPages - 1) //trang giua
                        {
                            ...
                            htmlStr.Append("						style='height: " + (k == v_countNumberOfPages - 1 ? v_rowHeightLast : v_rowHeight).ToString() + "; border-top: none;border-bottom:none;'>&nbsp;" + dt_d.Rows[v_index][7] + "</td>                                                   \n");
                            htmlStr.Append("					<td colspan=8 class=xl14522200 width=424                                                                                 \n");
            ...
            htmlStr.Append("    				<td colspan=4 height=26 class=xl13522200 style='height: 20.25pt'><span                                                               \n");
            htmlStr.Append("    					style='mso-spacerun: yes'>    </span>Ng&#432;&#7901;i chuy&#7875;n                                                               \n");
            htmlStr.Append("    					&#273;&#7893;i <font class='font622200'>(Converter)</font><font                                                               \n");
            htmlStr.Append("    					class='font522200'><span style='mso-spacerun: yes'>                                   </span></font></td>                                                               \n");
            htmlStr.Append("    				<td colspan=5 class=xl13222200 style='text-align: center'>Khách hàng <font                                                               \n");
            htmlStr.Append("    					class='font822200'>(Customer)</font></td>                                                               \n");
            ...
            htmlStr.Append("    				<td colspan=4 height=24 class=xl13622200 style='height: 15.30pt'><span                                                               \n");
            htmlStr.Append("    					style='mso-spacerun: yes'>   </span>(Ký, ghi rõ h&#7885; tên)</td>                                                               \n");
            htmlStr.Append("    				<td colspan=5 class=xl13322200>(Ký, ghi rõ h&#7885; tên)</td>                                                               \n");
            htmlStr.Append("    				<td class=xl9322200>&nbsp;</td>                                                               \n");
            htmlStr.Append("    				<td class=xl9322200>&nbsp;</td>                                                               \n");
            ...
            htmlStr.Append("    			</tr>                                                               \n");
            htmlStr.Append("    			<tr height=24 style='height: 15.30pt'>                                                               \n");
            htmlStr.Append("    				<td colspan=4 height=24 class=xl14422200 style='height: 15.30pt'><span                                                               \n");
            htmlStr.Append("    					style='mso-spacerun: yes'>      </span>(Signature, full name)</td>                                                               \n");
            htmlStr.Append("    				<td colspan=5 class=xl13422200>(Signature, full name)</td>                                                               \n");
            ...
            htmlStr.Append("    				<td height=33 class=xl9722200 style='height: 20.05pt'>&nbsp;" + dt.Rows[0]["convert_name"] + "</td>                                                               \n");
            htmlStr.Append("    				<td class=xl9322200>&nbsp;</td>                                                               \n");
            htmlStr.Append("    				<td class=xl9322200>&nbsp;</td>                                                               \n");
            htmlStr.Append("    				<td class=xl9322200>&nbsp;</td>                                                               \n");
            htmlStr.Append("    				<td class=xl9322200>&nbsp;</td>                                                               \n");
            ...
            htmlStr.Append("    			</tr>                                                               \n");
            htmlStr.Append("    			<tr height=24 style='height: 15.30pt'>                                                               \n");
            htmlStr.Append("    				<td height=24 class=xl9722200 colspan=2 style='height: 15.30pt'>" + dt.Rows[0]["convert_date"] + "</td>                                                               \n");
            htmlStr.Append("    				<td class=xl9322200>&nbsp;</td>                                                               \n");
            htmlStr.Append("    				<td class=xl9322200>&nbsp;</td>                                                               \n");
            htmlStr.Append("    				<td class=xl9322200>&nbsp;</td>                                                               \n");
            htmlStr.Append("    				<td class=xl9322200>&nbsp;</td>                                                               \n");
            ...
            //string filePath = "D:\\webproject\\e-invoice-ws\02.Web\\AttachFileText\\" + dt.Rows[0]["templateCode"].ToString().Replace("/", "") + "_" + dt.Rows[0]["InvoiceSerialNo"].ToString().Replace("/", "") + "_" + dt.Rows[0]["InvoiceNumber"] + ".html";
