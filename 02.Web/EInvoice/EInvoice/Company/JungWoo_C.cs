...
namespace EInvoice.Company
{
    public class JungWoo_C
    {
        public static string View(string tei_einvoice_m_pk, string tei_company_pk, string dbName)
        {
            ...
            int pos = 13, pos_lv = 20, v_count = 0, count_page = 0, count_page_v = 0, r = 0, x = 0;
            ...
            if (dt.Rows[0]["AMOUNT_WORD_VIE"].ToString().Trim().Length > 0)
            {
            ...
            else
            {
                ...
                read_prive = Num2VNText(dt.Rows[0]["totalamountinword_vie"].ToString(), "VND");

                read_prive = read_prive.Replace(",", "");

                read_prive = read_prive.Substring(0, 2) + read_prive.Substring(2).ToLower().Replace("viet nam dong", "Viet Nam Dong");
            ...
            if (dt.Rows[0]["CURRENCYCODEUSD"].ToString().Trim() == "VND")
            {
                vat_display = dt.Rows[0]["VAT_TR_AMT_VIE_DISPLAY"].ToString();
            }
            else
            {
                vat_display = dt.Rows[0]["VAT_TR_AMT_USD_DISPLAY"].ToString();
            }
            ...
            htmlStr.Append("					style='width: 108pt'>M&#7851;u s&#7889;:<span                                                                                                           \n");
            htmlStr.Append("					style='mso-spacerun: yes'>    </span><font class='font513844'>" + dt.Rows[0]["templateCode"] + "</font></td>                                                               \n");
            htmlStr.Append("				<td class=xl1513844></td>                                                                                                                                   \n");
            htmlStr.Append("			</tr>                                                                                                                                                           \n");
            ...
            htmlStr.Append("					class='font513844'>" + dt.Rows[0]["INVOICESERIALNO"] + "</font>                                                                                                             \n");
            htmlStr.Append("				</td>                                                                                                                                                       \n");
            htmlStr.Append("				<td class=xl1513844></td>                                                                                                                                   \n");
            htmlStr.Append("			</tr>                                                                                                                                                           \n");
            ...
            htmlStr.Append("					style='height: 19.42pt; width: 109pt'><![if !vml]><span style='mso-ignore:vglayout;position:absolute;z-index:1;margin-left:85px;margin-right:10px;margin-top:0px;width:707px;");
            htmlStr.Append(" height:702px'><img width=707 height=702 src='D:\\webproject\\e-invoice-ws\\02.Web\\EInvoice\\img\\OTTOGI_HCM_cancel.png' v:shapes='Picture_x0020_8 Straight_x0020_Connector_x0020_4 Straight_x0020_Connector_x0020_6'></span><![endif]>");
            htmlStr.Append("&#272;&#417;n v&#7883;                                                                                             \n");
            ...
            htmlStr.Append("			</tr>                                                                                                                                                           \n");
          			...
          			{                                                                                                                        
          			    ...
          			    {                                                                                                                                                      
                            ...
                            htmlStr.Append("					<tr height=26 style='mso-height-source: userset; height: 20.7pt;'>                                                                                      \n");
                            htmlStr.Append("						<td height=26 class=xl7913844 width=30                                                                                                              \n");
                            htmlStr.Append("							style='height: 18.09pt; border-top: none; width: 20.7pt; font-size:9pt;'>" + dt_d.Rows[0]["STT"] + "</td>                                                                     \n");
                            ...
                            htmlStr.Append("					<tr height=26 style='mso-height-source: userset; height: 20.7pt;'>                                                                                      \n");
                            htmlStr.Append("						<td height=26 class=xl7913844 width=30                                                                                                              \n");
                            htmlStr.Append("							style='height: 18.09pt; border-top: none; width: 20.7pt; font-size:9pt;'>"+ dt_d.Rows[dtR]["STT"] + "</td>                                                                     \n");
                            htmlStr.Append("						<td colspan=2 class=xl11513844 width=115                                                                                                            \n");
                            ...
                            htmlStr.Append("				<tr height=26 style='mso-height-source: userset; height: 20.7pt;'>                                                                                          \n");
                            htmlStr.Append("					<td height=26 class=xl7913844 width=30                                                                                                                  \n");
                            htmlStr.Append("						style='height: 18.09pt; border-top: none; width: 20.7pt;font-size:9.0pt;'>" + dt_d.Rows[dtR]["STT"] + "</td>                                                                         \n");
            ...
            htmlStr.Append("					<tr height=26 style='mso-height-source: userset; height: 20.7pt;'>                                                                                      \n");
            htmlStr.Append("						<td height=26 class=xl7913844 width=30                                                                                                              \n");
            htmlStr.Append("							style='height: 18.09pt; border-top: none; width: 20.7pt;font-size:9.0pt;'>&nbsp;</td>                                                                            \n");
            htmlStr.Append("						<td colspan=2 class=xl11513844 width=115                                                                                                            \n");
            ...
            htmlStr.Append("					<tr height=26 style='mso-height-source: userset; height: 20.7pt;'>                                                                                      \n");
            htmlStr.Append("						<td height=26 class=xl7913844 width=30                                                                                                              \n");
            htmlStr.Append("							style='height: 18.09pt; border-top: none; width: 20.7pt'>&nbsp;</td>                                                                            \n");
            htmlStr.Append("						<td colspan=2 class=xl11513844 width=115                                                                                                            \n");
            htmlStr.Append("							style='border-left: none; width: 86pt'>&nbsp;</td>                                                                                              \n");
            htmlStr.Append("						<td colspan=5 class=xl11713844 width=233                                                                                                            \n");
            htmlStr.Append("							style='border-left: none; width: 174pt'>&nbsp;</td>                                                                                             \n");
            ...
            htmlStr.Append("					style='border-right: 1pt solid black; border-left: none; width: 78pt'>" + dt.Rows[0]["total_tr_amt_vie"] + "&nbsp;</td>                                                        \n");
            htmlStr.Append("				<td class=xl1513844></td>                                                                                                                                   \n");
            htmlStr.Append("			</tr>                                                                                                                                                           \n");
            htmlStr.Append("			<tr height=24 style='mso-height-source: userset; height: 19.25pt'>                                                                                               \n");
            ...
            htmlStr.Append("				<td colspan=5 class=xl10713844 width=105                                                                                                                    \n");
            htmlStr.Append("					style='border-right: 1pt solid black; border-left: none; width: 78pt'>" + vat_display + "&nbsp;</td>                                                      \n");
            htmlStr.Append("				<td class=xl1513844></td>                                                                                                                                   \n");
            htmlStr.Append("			</tr>                                                                                                                                                           \n");
            htmlStr.Append("			<tr height=24 style='mso-height-source: userset; height: 19.25pt'>                                                                                               \n");
            ...
            htmlStr.Append("				</td>                                                                                                                                                       \n");
            htmlStr.Append("				<td colspan=2 class=xl7413844 width=97 style='width: 73pt'>" + dt.Rows[0]["total_tr_amt"] + "&nbsp;</td>                                                                       \n");
            ...
            htmlStr.Append("					style='border-right: 1pt solid black; border-left: none; width: 78pt'>" + dt.Rows[0]["TOTALAMOUNT_DISPLAY_VIE_2"] + "&nbsp;</td>                                               \n");
            htmlStr.Append("				<td class=xl1513844></td>                                                                                                                                   \n");
            htmlStr.Append("			</tr>                                                                                                                                                           \n");
            ...
            htmlStr.Append("			</tr>                                                                                                                                                           \n");
            htmlStr.Append("			<tr height=21 style='mso-height-source: userset; height: 18.00pt'>                                                                                             \n");
            htmlStr.Append("				<td height=21 class=xl8713844 style='height: 18.00pt'>Mã                                                                                                   \n");
            htmlStr.Append("					nh&#7853;n hóa &#273;&#417;n:</td>                                                                                                                      \n");
            htmlStr.Append("				<td class=xl6513844 width=99 style='width: 66.6pt'></td>                                                                                                    \n");
            htmlStr.Append("				<td class='xl6513844 font1113845' width=16 style='width: 10.8pt'><span class='font1113845'>" + dt.Rows[0]["matracuu"] + "</span></td>                                                                                                    \n");
            htmlStr.Append("				<td class=xl6513844 width=90 style='width: 60.3pt'></td>                                                                                                    \n");
            htmlStr.Append("				<td class=xl6513844 width=70 style='width: 47.7pt'></td>                                                                                                    \n");
            htmlStr.Append("				<td class=xl6513844 width=27 style='width: 16.2pt'></td>                                                                                                    \n");
            htmlStr.Append("				<td class=xl6513844 width=23 style='width: 15.3pt'></td>                                                                                                    \n");
            ...
            //string filePath = 'C:\\Users\\genuwin\\Desktop\\' + tei_einvoice_m_pk + '.xml';  demo
            string filePath = "";
            if (dt.Rows[0]["Old_YN"].ToString() == "N")
            {
                filePath = "D:\\webproject\\e-invoice-ws\\02.Web\\AttachFileXml\\" + dt.Rows[0]["templateCode"].ToString().Replace("/", "") + "_" + dt.Rows[0]["InvoiceSerialNo"].ToString().Replace("/", "") + "_" + dt.Rows[0]["InvoiceNumber"] + ".xml";            //using (System.IO.StreamWriter file = new System.IO.StreamWriter(@"E:\\webproject\\E_INVOICE_WS\\02.Web\\AttachFileText\\" + tei_einvoice_m_pk + ".txt"))

                // using (System.IO.StreamWriter file = new System.IO.StreamWriter(@"D:\\webproject\\e-invoice-ws\\02.Web\\AttachFileText\\" + dt.Rows[0]["templateCode"].ToString().Replace("/", "") + "_" + dt.Rows[0]["InvoiceSerialNo"].ToString().Replace("/", "") + "_" + dt.Rows[0]["InvoiceNumber"] + ".txt"))
                // {
            ...
            {
                filePath = "D:\\webproject\\e-invoice-ws\\02.Web\\AttachFileXml\\" + tei_einvoice_m_pk + ".xml";
                ...
                if (!File.Exists(filePath))
                {
                    ...
                    l_Attribute_08 = "", l_Attribute_09 = "", l_Attribute_10 = "", l_CompanyEmail = "", l_Seller_AccountName = "", l_CustomerCode = "", l_EmailDeliver = "",
                    l_CustomerBankName = "", l_CustomerType = "", l_CurrencyUnit = "", l_TaxAmountFree = "", l_TaxAmount0 = "", l_TaxAmount5 = "",
                    l_TaxAmount10 = "", l_DiscountAmount = "", l_PromotionAmount = "", l_Note = "", l_External1 = "", l_External2 = "", l_External3 = "", l_NumberExternal1 = "", l_NumberExternal2 = "", l_NumberExternal3 = "", l_KindOfInvoice = "";
                    String xmlStr = "";


                    l_key = dt.Rows[0]["key"].ToString();
                    l_InvoiceType = "01GTKT";// dt.Rows[0]["InvoiceType"].ToString();
                    ...
                    l_InvoiceName = "Hóa đơn giá trị gia tăng"; dt.Rows[0]["InvoiceName"].ToString();
                    ...
                    l_Seller_TaxCode = dt.Rows[0]["tax_code_xml"].ToString();// dt.Rows[0]["Seller_TaxCode"].ToString();
                    ...
                    l_ExchangeRate = "1.000000000000";// dt.Rows[0]["ExchangeRate"].ToString();
                    l_NetAmount = dt.Rows[0]["netamount_xml"].ToString();// dt.Rows[0]["netamount_display"].ToString();
                    l_TaxRate = dt.Rows[0]["vat_rate_xml"].ToString();
                    l_VATAmount = dt.Rows[0]["vatamount_xml"].ToString();  //dt.Rows[0]["vatamount_display"].ToString();
                    l_TotalAmount = dt.Rows[0]["totalamount_xml"].ToString();// dt.Rows[0]["totalamount_display"].ToString();
                    ...
                    l_CompanyEmail = "";
                    l_Seller_AccountName = dt.Rows[0]["SELLER_BANKNAME"].ToString();
                    ...
                    //XmlNode Invoice1 = doc.CreateElement("Invoice1");
                    //Inv.AppendChild(Invoice1);

                    //InvoiceName elements
                    XmlNode InvoiceName = doc.CreateElement("InvoiceName");
                    InvoiceName.AppendChild(doc.CreateTextNode(l_InvoiceName));   /// l_InvoiceType
                    ...
                    //templateCode elements  InvoicePattern
                    //XmlNode templateCode = doc.CreateElement("templateCode");
                    XmlNode templateCode = doc.CreateElement("InvoicePattern");
                    ...
                    XmlNode InvoiceSerialNo = doc.CreateElement("InvoiceSerial");
                    ...
                    //InvoiceDate elements
                    XmlNode InvoiceIssuedDate = doc.CreateElement("InvoiceDate");
                    ...
                    XmlNode Seller_Name = doc.CreateElement("CompanyName");
                    ...
                    //Seller_Tel elements
                    XmlNode Seller_Tel = doc.CreateElement("CompanyPhone");
                    Seller_Tel.AppendChild(doc.CreateTextNode(l_Seller_Tel));
                    content.AppendChild(Seller_Tel);

                    //Seller_Fax elements
                    XmlNode Seller_Fax = doc.CreateElement("CompanyFax");
                    Seller_Fax.AppendChild(doc.CreateTextNode(l_Seller_Fax));
                    content.AppendChild(Seller_Fax);

                    //Seller_Fax elements
                    XmlNode CompanyEmail = doc.CreateElement("CompanyEmail");
                    Seller_Fax.AppendChild(doc.CreateTextNode(l_CompanyEmail));
                    content.AppendChild(CompanyEmail);

                    //Seller_AccountNo elements
                    XmlNode Seller_AccountNo = doc.CreateElement("CompanyBankAccount");
                    ...
                    XmlNode Seller_AccountNo2 = doc.CreateElement("CompanyBankAccount2");
                    Seller_AccountNo2.AppendChild(doc.CreateTextNode(l_Seller_AccountNo2));
                    content.AppendChild(Seller_AccountNo2);

                    //Seller_AccountNo elements
                    XmlNode CompanyBankName = doc.CreateElement("CompanyBankName");
                    CompanyBankName.AppendChild(doc.CreateTextNode(l_Seller_AccountName));
                    content.AppendChild(CompanyBankName);

                    //Seller_AccountNo elements
                    XmlNode CustomerCode = doc.CreateElement("CustomerCode");
                    CustomerCode.AppendChild(doc.CreateTextNode(l_CustomerCode));
                    content.AppendChild(CustomerCode);

                    //BuyerTaxCode elements
                    XmlNode BuyerTaxCode = doc.CreateElement("CustomerTaxCode");
                    BuyerTaxCode.AppendChild(doc.CreateTextNode(l_BuyerTaxCode));
                    content.AppendChild(BuyerTaxCode);

                    //Seller_Website elements
                    XmlNode Seller_Website = doc.CreateElement("CustomerWebsite");
                    ...
                    XmlNode BuyerLegalName = doc.CreateElement("CustomerName");
                    BuyerLegalName.AppendChild(doc.CreateTextNode(l_BuyerLegalName));
                    content.AppendChild(BuyerLegalName);

                    //BuyerAddress elements
                    XmlNode BuyerAddress = doc.CreateElement("CustomerAddress");
                    BuyerAddress.AppendChild(doc.CreateTextNode(l_BuyerAddress));
                    content.AppendChild(BuyerAddress);

                    //BuyerPhone elements
                    XmlNode BuyerPhone = doc.CreateElement("CustomerPhone");
                    BuyerPhone.AppendChild(doc.CreateTextNode(l_BuyerPhone));
                    content.AppendChild(BuyerPhone);

                    //BuyerFax elements
                    XmlNode BuyerFax = doc.CreateElement("CustomerFax");
                    BuyerFax.AppendChild(doc.CreateTextNode(l_BuyerFax));
                    content.AppendChild(BuyerFax);


                    //BuyerFax elements
                    XmlNode EmailDeliver = doc.CreateElement("EmailDeliver");
                    EmailDeliver.AppendChild(doc.CreateTextNode(l_EmailDeliver));
                    content.AppendChild(EmailDeliver);


                    //BuyerAccountNo elements
                    XmlNode BuyerAccountNo = doc.CreateElement("CustomerBankAccount");
                    BuyerAccountNo.AppendChild(doc.CreateTextNode(l_BuyerAccountNo));
                    content.AppendChild(BuyerAccountNo);


                    //BuyerAccountNo elements
                    XmlNode CustomerBankName = doc.CreateElement("CustomerBankName");
                    CustomerBankName.AppendChild(doc.CreateTextNode(l_CustomerBankName));
                    content.AppendChild(CustomerBankName);

                    //BuyerAccountNo elements
                    XmlNode CustomerType = doc.CreateElement("CustomerType");
                    CustomerType.AppendChild(doc.CreateTextNode(l_CustomerType));
                    content.AppendChild(CustomerType);


                    //BuyerPONo elements
                    //XmlNode BuyerPONo = doc.CreateElement("CustomerPONo");
                    //BuyerPONo.AppendChild(doc.CreateTextNode(l_BuyerPONo));
                    //content.AppendChild(BuyerPONo);

                    //BuyerCInvoiceNo elements
                    //XmlNode BuyerCInvoiceNo = doc.CreateElement("CustomerCInvoiceNo");
                    //BuyerCInvoiceNo.AppendChild(doc.CreateTextNode(l_BuyerCInvoiceNo));
                    //content.AppendChild(BuyerCInvoiceNo);


                    //ExchangeRate elements
                    XmlNode CurrencyUnit = doc.CreateElement("CurrencyUnit");
                    CurrencyUnit.AppendChild(doc.CreateTextNode(l_CurrencyUnit));
                    content.AppendChild(CurrencyUnit);
                    ...
                    //NetAmount elements
                    XmlNode NetAmount = doc.CreateElement("Amount");
                    ...
                    //VATAmount elements
                    XmlNode VATAmount = doc.CreateElement("TaxAmount");
                    ...
                    XmlNode TotalAmountInWord = doc.CreateElement("AmountInWords");
                    TotalAmountInWord.AppendChild(doc.CreateTextNode(l_TotalAmountInWord));
                    content.AppendChild(TotalAmountInWord);


                    //TaxAmountFree elements
                    XmlNode TaxAmountFree = doc.CreateElement("TaxAmountFree");
                    TaxAmountFree.AppendChild(doc.CreateTextNode(l_TaxAmountFree));
                    content.AppendChild(TaxAmountFree);

                    //TaxAmount0 elements
                    XmlNode TaxAmount0 = doc.CreateElement("TaxAmount0");
                    TaxAmount0.AppendChild(doc.CreateTextNode(l_TaxAmount0));
                    content.AppendChild(TaxAmount0);

                    //TaxAmount5 elements
                    XmlNode TaxAmount5 = doc.CreateElement("TaxAmount5");
                    TaxAmount5.AppendChild(doc.CreateTextNode(l_TaxAmount5));
                    content.AppendChild(TaxAmount5);

                    //TaxAmount10 elements
                    XmlNode TaxAmount10 = doc.CreateElement("TaxAmount10");
                    TaxAmount10.AppendChild(doc.CreateTextNode(l_TaxAmount10));
                    content.AppendChild(TaxAmount10);


                    //DiscountAmount elements
                    XmlNode DiscountAmount = doc.CreateElement("DiscountAmount");
                    DiscountAmount.AppendChild(doc.CreateTextNode(l_DiscountAmount));
                    content.AppendChild(DiscountAmount);


                    //PromotionAmount elements
                    XmlNode PromotionAmount = doc.CreateElement("PromotionAmount");
                    PromotionAmount.AppendChild(doc.CreateTextNode(l_PromotionAmount));
                    content.AppendChild(PromotionAmount);


                    //Note elements
                    XmlNode Note = doc.CreateElement("Note");
                    Note.AppendChild(doc.CreateTextNode(l_Note));
                    content.AppendChild(Note);

                    //External1 elements
                    XmlNode External1 = doc.CreateElement("External1");
                    External1.AppendChild(doc.CreateTextNode(l_External1));
                    content.AppendChild(External1);

                    //External2 elements
                    XmlNode External2 = doc.CreateElement("External2");
                    External2.AppendChild(doc.CreateTextNode(l_External2));
                    content.AppendChild(External2);

                    //External3 elements
                    XmlNode External3 = doc.CreateElement("External3");
                    External3.AppendChild(doc.CreateTextNode(l_External3));
                    content.AppendChild(External3);

                    //TotalAmountInWord elements
                    XmlNode NumberExternal1 = doc.CreateElement("NumberExternal1");
                    NumberExternal1.AppendChild(doc.CreateTextNode(l_NumberExternal1));
                    content.AppendChild(NumberExternal1);

                    //NumberExternal2 elements
                    XmlNode NumberExternal2 = doc.CreateElement("NumberExternal2");
                    NumberExternal2.AppendChild(doc.CreateTextNode(l_NumberExternal2));
                    content.AppendChild(NumberExternal2);

                    //NumberExternal3 elements
                    XmlNode NumberExternal3 = doc.CreateElement("NumberExternal3");
                    NumberExternal3.AppendChild(doc.CreateTextNode(l_NumberExternal3));
                    content.AppendChild(NumberExternal3);


                    //KindOfInvoice elements
                    XmlNode KindOfInvoice = doc.CreateElement("KindOfInvoice");
                    KindOfInvoice.AppendChild(doc.CreateTextNode(l_KindOfInvoice));
                    content.AppendChild(KindOfInvoice);
                    ...
                    //Attribute_01 elements
                    //XmlNode Attribute_01 = doc.CreateElement("Attribute_01");
                    //Attribute_01.AppendChild(doc.CreateTextNode(l_Attribute_01));
                    //content.AppendChild(Attribute_01);

                    //Attribute_02 elements
                    //XmlNode Attribute_02 = doc.CreateElement("Attribute_02");
                    //Attribute_02.AppendChild(doc.CreateTextNode(l_Attribute_02));
                    //content.AppendChild(Attribute_02);

                    //Attribute_03 elements
                    //XmlNode Attribute_03 = doc.CreateElement("Attribute_03");
                    //Attribute_03.AppendChild(doc.CreateTextNode(l_Attribute_03));
                    //content.AppendChild(Attribute_03);

                    //Attribute_04 elements
                    //XmlNode Attribute_04 = doc.CreateElement("Attribute_04");
                    //Attribute_04.AppendChild(doc.CreateTextNode(l_Attribute_04));
                    //content.AppendChild(Attribute_04);

                    //Attribute_05 elements
                    //XmlNode Attribute_05 = doc.CreateElement("Attribute_05");
                    //Attribute_05.AppendChild(doc.CreateTextNode(l_Attribute_05));
                    //content.AppendChild(Attribute_05);

                    //Attribute_06 elements
                    //XmlNode Attribute_06 = doc.CreateElement("Attribute_06");
                    //Attribute_06.AppendChild(doc.CreateTextNode(l_Attribute_06));
                    //content.AppendChild(Attribute_06);

                    //Attribute_07 elements
                    //XmlNode Attribute_07 = doc.CreateElement("Attribute_07");
                    //Attribute_07.AppendChild(doc.CreateTextNode(l_Attribute_07));
                    //content.AppendChild(Attribute_07);

                    //Attribute_08 elements
                    //XmlNode Attribute_08 = doc.CreateElement("Attribute_08");
                    //Attribute_08.AppendChild(doc.CreateTextNode(l_Attribute_08));
                    //content.AppendChild(Attribute_08);

                    //Attribute_09 elements
                    //XmlNode Attribute_09 = doc.CreateElement("Attribute_09");
                    //Attribute_09.AppendChild(doc.CreateTextNode(l_Attribute_09));
                    //content.AppendChild(Attribute_09);

                    //Attribute_10 elements
                    //XmlNode Attribute_10 = doc.CreateElement("Attribute_10");
                    //Attribute_10.AppendChild(doc.CreateTextNode(l_Attribute_10));
                    //content.AppendChild(Attribute_10);
                    ...
                    OracleDataAdapter da_x = new OracleDataAdapter(command);
                    da_x.Fill(ds_x);
                    DataTable dt_x = ds_x.Tables[0];*/
                    ...
                    for (int dtR = 0; dtR < dt_d.Rows.Count; dtR++)
                    {
                        //Product elements dt_x
                        XmlNode Product = doc.CreateElement("Product");
                        Products.AppendChild(Product);

                        //LineNumber elements
                        XmlNode LineNumber = doc.CreateElement("LineNumber");
                        LineNumber.AppendChild(doc.CreateTextNode(dt_d.Rows[dtR][15].ToString()));
                        Product.AppendChild(LineNumber);

                        //LineNumber elements
                        XmlNode LinePrint = doc.CreateElement("LinePrint");
                        LinePrint.AppendChild(doc.CreateTextNode(dt_d.Rows[dtR][7].ToString()));
                        Product.AppendChild(LinePrint);
                        ...
                        //ItemUnit elements
                        XmlNode ItemUnit = doc.CreateElement("UnitOfMeasure");
                        ItemUnit.AppendChild(doc.CreateTextNode(dt_d.Rows[dtR][1].ToString()));
                        Product.AppendChild(ItemUnit);

                        //ItemQuantity elements
                        XmlNode ItemQuantity = doc.CreateElement("Quantity");
                        ItemQuantity.AppendChild(doc.CreateTextNode(dt_d.Rows[dtR][12].ToString()));
                        Product.AppendChild(ItemQuantity);

                        //ItemPrice elements
                        XmlNode ItemPrice = doc.CreateElement("Price");
                        ItemPrice.AppendChild(doc.CreateTextNode(dt_d.Rows[dtR][11].ToString()));
                        Product.AppendChild(ItemPrice);

                        //ItemAmount elements
                        XmlNode ItemAmount = doc.CreateElement("Amount");
                        ItemAmount.AppendChild(doc.CreateTextNode(dt_d.Rows[dtR][10].ToString()));
                        Product.AppendChild(ItemAmount);

                        //DiscountRate elements
                        XmlNode DiscountRate = doc.CreateElement("DiscountRate");
                        DiscountRate.AppendChild(doc.CreateTextNode("0"));
                        Product.AppendChild(DiscountRate);

                        //ItemAmount elements
                        XmlNode DiscountAmount_d = doc.CreateElement("DiscountAmount");
                        DiscountAmount_d.AppendChild(doc.CreateTextNode("0.00"));
                        Product.AppendChild(DiscountAmount_d);

                        //ItemAmount elements
                        XmlNode TaxRate_d = doc.CreateElement("TaxRate");
                        TaxRate_d.AppendChild(doc.CreateTextNode(dt_d.Rows[dtR][13].ToString()));
                        Product.AppendChild(TaxRate_d);

                        //ItemAmount elements
                        XmlNode TaxAmount = doc.CreateElement("TaxAmount");
                        TaxAmount.AppendChild(doc.CreateTextNode(dt_d.Rows[dtR][14].ToString()));
                        Product.AppendChild(TaxAmount);

                        //Note elements
                        XmlNode Note_d = doc.CreateElement("Note");
                        Note_d.AppendChild(doc.CreateTextNode(""));
                        Product.AppendChild(Note_d);

                        //Note elements
                        XmlNode External1_d = doc.CreateElement("External1");
                        External1_d.AppendChild(doc.CreateTextNode(""));
                        Product.AppendChild(External1_d);

                        //Note elements
                        XmlNode External2_d = doc.CreateElement("External2");
                        External2_d.AppendChild(doc.CreateTextNode(""));
                        Product.AppendChild(External2_d);

                        //Note elements
                        XmlNode External3_d = doc.CreateElement("External3");
                        External3_d.AppendChild(doc.CreateTextNode(""));
                        Product.AppendChild(External3_d);

                        //Note elements
                        XmlNode NumberExternal1_d = doc.CreateElement("NumberExternal1");
                        NumberExternal1_d.AppendChild(doc.CreateTextNode("0"));
                        Product.AppendChild(NumberExternal1_d);

                        //Note elements
                        XmlNode NumberExternal2_d = doc.CreateElement("NumberExternal2");
                        NumberExternal2_d.AppendChild(doc.CreateTextNode("0"));
                        Product.AppendChild(NumberExternal2_d);

                        //Note elements
                        XmlNode NumberExternal3_d = doc.CreateElement("NumberExternal3");
                        NumberExternal3_d.AppendChild(doc.CreateTextNode("0"));
                        Product.AppendChild(NumberExternal3_d);
                    }
