...
{
    public class PXKKVCNB_ALL_02_T
    {
        public static string View(string tei_einvoice_m_pk, string tei_company_pk, string dbName)
        {
            ...
            for (int k = 0; k < v_countNumberOfPages; k++)
            {
                ...
                htmlStr.Append("	  class='font622214'>Currency</font><font class='font722214'>):</font> " + dt.Rows[0]["CurrencyCodeUSD"] + "" + dt.Rows[0]["CurrencyCodeUSD"] + "</td>                                                                                         \n");
