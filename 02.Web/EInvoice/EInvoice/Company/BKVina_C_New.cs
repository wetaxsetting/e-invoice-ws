        ...
        public static string View(string tei_einvoice_m_pk, string tei_company_pk, string dbName)
        {
            ...
            */
            ...
            for (int k = 0; k < v_countNumberOfPages; k++)
            {
                ...
                htmlStr.Append("		  <td class=xl65></td>                                                                                                                                                               \n");
                //htmlStr.Append("		  <td class=xl65></td>                                                                                                                                                               \n");
                htmlStr.Append("		  <td colspan=8 class=xl109>(HÓA &#272;&#416;N CHUY&#7874;N &#272;&#7892;I T&#7914; HÓA &#272;&#416;N &#272;I&#7878;N T&#7916;)</td>                                                                                                                                                    \n");
                htmlStr.Append("		  <td class=xl65></td>                                                                                                                                                               \n");
                ...
                htmlStr.Append("		  class='font15'>: USD</font></td>                                                                                                               \n");
                htmlStr.Append("		  <td colspan=2 class=xl173></td>                                                                                                                                                    \n");
            ...
            htmlStr.Append("      <td colspan=4 class=xl72 style='text-align: center; '>CONVERTER</td>                                                               \n");
            htmlStr.Append("      <td colspan=4 class=xl73>NG&#431;&#7900;I MUA HÀNG/ <font class='font8'>BUYER</font></td>                                                               \n");
            htmlStr.Append("      <td class=xl65></td>                                                               \n");
            htmlStr.Append("      <td class=xl65></td>                                                               \n");
            htmlStr.Append("      <td class=xl65></td>                                                               \n");
            ...
            htmlStr.Append("      <td height=18 class=xl65 style='height:13.2pt'></td>                                                               \n");
            htmlStr.Append("      <td colspan=4 class=xl72 style='text-align: center; '>Ký, ghi rõ h&#7885;, tên</td>                                                               \n");
            htmlStr.Append("      <td colspan=4 class=xl73>Ký, ghi rõ h&#7885;, tên</td>                                                               \n");
            htmlStr.Append("      <td class=xl65></td>                                                               \n");
            htmlStr.Append("      <td class=xl65></td>                                                               \n");
            htmlStr.Append("      <td class=xl65></td>                                                               \n");
            htmlStr.Append("      <td colspan=6 class=xl73>Ký, &#273;óng                                                               \n");
            ...
            htmlStr.Append("      <td colspan=4 class=xl164 style='font-style:italic; font-size: 9.0pt; text-align: center; '>(Sign, full name)</td>                                                               \n");
            htmlStr.Append("      <td colspan=4 class=xl183><font class='font8'>(Sign, full name)</font></td>                                                               \n");
            htmlStr.Append("      <td class=xl97></td>                                                               \n");
            htmlStr.Append("      <td class=xl97></td>                                                               \n");
            htmlStr.Append("      <td class=xl97></td>                                                               \n");
            ...
            htmlStr.Append("				 <td class=xl72>&nbsp;Ngày chuyển đổi: " + dt.Rows[0]["Convert_Date"] + "<span style='mso-spacerun:yes'> </span></td>                                                                                                                                                     \n");
            htmlStr.Append("				  <td class=xl65></td>                                                                                                                                                       \n");
            htmlStr.Append("				  <td class=xl65></td>                                                                                                                                                       \n");
            htmlStr.Append("				  <td class=xl65></td>                                                                                                                                                       \n");
            htmlStr.Append("				  <td class=xl65></td>                                                                                                                                                       \n");
