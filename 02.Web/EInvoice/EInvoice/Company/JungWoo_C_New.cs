        ...
        public static string View(string tei_einvoice_m_pk, string tei_company_pk, string dbName)
        {
            ...
            */
            ...
            for (int k = 0; k < v_countNumberOfPages; k++)
            {
                ...
                htmlStr.Append("				<td colspan=15 class=xl12413844 width=420 style='width: 314pt'>(HÓA &#272;&#416;N CHUY&#7874;N &#272;&#7892;I T&#7914; HÓA &#272;&#416;N &#272;I&#7878;N T&#7916;)</td>                                                                                        \n");
            ...
            htmlStr.Append("				                                                                                                                                                            \n");
            htmlStr.Append("			</tr>                                                                                                                                                           \n");
            htmlStr.Append("    <tr height=18 style='mso-height-source: userset; height: 12.825pt'>                                                               \n");
            htmlStr.Append("    				<td colspan=4 height=18 class=xl6513844 width=235                                                               \n");
            htmlStr.Append("    					style='height: 12.825pt; width: 176pt'>NG&#431;&#7900;I                                                               \n");
            htmlStr.Append("    					CHUY&#7874;N &#272;&#7892;I</td>                                                               \n");
            htmlStr.Append("    				<td colspan=4 class=xl6513844 width=143 style='width: 107pt'>NG&#431;&#7900;I                                                               \n");
            htmlStr.Append("    					MUA HÀNG</td>                                                               \n");
            ...
            htmlStr.Append("    			<tr height=18 style='mso-height-source: userset; height: 12.825pt'>                                                               \n");
            htmlStr.Append("    				<td colspan=4 height=18 class=xl6513844 width=235                                                               \n");
            htmlStr.Append("    					style='height: 12.825pt; width: 176pt'>(Ký, h&#7885; tên)</td>                                                               \n");
            htmlStr.Append("    				<td colspan=4 class=xl6513844 width=143 style='width: 107pt'>(Ký,                                                               \n");
            ...
            htmlStr.Append("					colspan=1 style='height: 20.00pt; width: 20.7pt'></td>                                                                                                           \n");
            htmlStr.Append("				<td class=xl6513844 colspan=3 width=99 style='width: 66.6pt'>" + dt.Rows[0]["convert_name"] + "</td>                                                                                                    \n");
            ...
            htmlStr.Append("			</tr>                                                                                                                                                           \n");
            htmlStr.Append("			<tr height=21 style='mso-height-source: userset; height: 18.00pt'>                                                                                             \n");
            htmlStr.Append("				<td height=21 class=xl8613844 style='height: 18.00pt'>" + dt.Rows[0]["convert_date"] + "</td>                                                                                                \n");
            htmlStr.Append("				<td class=xl6513844 width=99 style='width: 66.6pt'></td>                                                                                                    \n");
            htmlStr.Append("				<td class=xl6513844 width=16 style='width: 10.8pt'></td>                                                                                                    \n");
            htmlStr.Append("				<td class=xl6513844 width=90 style='width: 60.3pt'></td>                                                                                                    \n");
            htmlStr.Append("				<td class=xl6513844 width=70 style='width: 47.7pt'></td>                                                                                                    \n");
