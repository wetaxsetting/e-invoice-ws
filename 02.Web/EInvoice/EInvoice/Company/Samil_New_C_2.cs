    ...
    public class Samil_New_C_2
    {
        public static string View(string tei_einvoice_m_pk, string tei_company_pk, string dbName)
        {
            ...
            */
            ...
            double v_totalHeightLastPage = 300;// 258.5;
            ...
            for (int k = 0; k < v_countNumberOfPages; k++)
            {
                ...
                htmlStr.Append("					style='border-right: 2.0pt double black; height: 20.00pt'>(HÓA &#272;&#416;N CHUY&#7874;N &#272;&#7892;I T&#7914; HÓA &#272;&#416;N &#272;I&#7878;N T&#7916;)</td>                                                                                \n");
                htmlStr.Append("			</tr>                                                                                                                                               \n");
                htmlStr.Append("                                                                                                                                                                \n");
            ...
            htmlStr.Append("					style='mso-spacerun: yes'> </span>T&#7927; giá / T&#7893;ng USD:<span                                                                       \n");
            htmlStr.Append("					style='mso-spacerun: yes'>                  </span></td>                                                                                    \n");
            htmlStr.Append("				<td colspan=3 class=xl13427974>&nbsp;" + dt.Rows[0]["exchangerate_no"] + "</td>                                                                                     \n");
            htmlStr.Append("				<td class=xl8827974>&nbsp;" + dt.Rows[0]["total_tr_amt"] + "</td>                                                                                                  \n");
            ...
            htmlStr.Append("				</td>                                                                                                                                           \n");
            htmlStr.Append("				<td class=xl9527974 style='border-left: none'>" + dt.Rows[0]["total_tr_amt_vie"] + "&nbsp;</td>                                                                        \n");
            htmlStr.Append("			</tr>                                                                                                                                               \n");
            htmlStr.Append("			<tr height=28 style='mso-height-source: userset; height: 22.0pt'>                                                                                   \n");
            htmlStr.Append("				<td colspan=2 height=28 class=xl13227974 style='height: 22.0pt'><span                                                                           \n");
            ...
            htmlStr.Append("				<td class=xl9527974 style='border-left: none; font-weight:600;'>" + dt.Rows[0]["TOTALAMOUNT_DISPLAY_VIE_2"] + "&nbsp;</td>                                                               \n");
            htmlStr.Append("			</tr>                                                                                                                                               \n");
            ...
            htmlStr.Append("			</tr>                                                                                                                                               \n");
            htmlStr.Append("                                                                                                                                                                \n");
            htmlStr.Append("    	<tr height=26 style='mso-height-source: userset; height: 14pt'>                                                               \n");
            htmlStr.Append("    				<td colspan=3 height=26 class=xl12627974                                                               \n");
            htmlStr.Append("    					style='height: 14pt; vertical-align: center'>Người chuyển đổi<font class='font1027974'>(Converter)</font></td>                                                               \n");
            htmlStr.Append("    				<td colspan=5 class=xl12427974><span style='mso-spacerun: yes'>                                                                  \n");
            htmlStr.Append("    				</span>Người mua hàng <font class='font1027974'>(Buyer ) </font></td>                                                               \n");
            ...
            htmlStr.Append("    			</tr>                                                               \n");
            htmlStr.Append("    			<tr height=23 style='height: 14pt'>                                                               \n");
            htmlStr.Append("    				<td colspan=3 height=23 class=xl6727974 style='height: 14pt'><span                                                               \n");
            htmlStr.Append("    					style='mso-spacerun: yes'>   </span>(Ký, ghi rõ h&#7885; tên)</td>                                                               \n");
            htmlStr.Append("    				<td colspan=5 class=xl6827974><span style='mso-spacerun: yes'>                                                                 \n");
            htmlStr.Append("    				</span>(Ký, ghi rõ h&#7885; tên)</td>                                                               \n");
            htmlStr.Append("    				<td colspan=7 class=xl6827974                                                               \n");
            htmlStr.Append("    					style='border-right: 2.0pt double black'><span                                                               \n");
            htmlStr.Append("    					style='mso-spacerun: yes'>  </span>(Ký, ghi rõ h&#7885; tên)</td>                                                               \n");
            htmlStr.Append("    			</tr>                                                               \n");
            htmlStr.Append("    			<tr height=23 style='height: 14pt'>                                                               \n");
            htmlStr.Append("    				<td colspan=3 height=23 class=xl12827974 style='height: 14pt'><span                                                               \n");
            htmlStr.Append("    					style='mso-spacerun: yes'>    </span>(Signature, full name)</td>                                                               \n");
            htmlStr.Append("    				<td colspan=5 class=xl12927974><span style='mso-spacerun: yes'>                                                                  \n");
            htmlStr.Append("    				</span>(Signature, full name)</td>                                                               \n");
            ...
            htmlStr.Append("				<td height=20 class=xl8227974 style='height: 13.0pt'>&nbsp;" + dt.Rows[0]["convert_name"] + "</td>                                                                                \n");
            htmlStr.Append("				<td class=xl6627974>&nbsp;</td>                                                                                                                 \n");
            htmlStr.Append("				<td class=xl6627974>&nbsp;</td>                                                                                                                 \n");
            htmlStr.Append("				<td class=xl6627974>&nbsp;</td>                                                                                                                 \n");
            htmlStr.Append("				<td class=xl6627974>&nbsp;</td>                                                                                                                 \n");
            ...
            htmlStr.Append("			</tr>                                                                                                                                               \n");
            htmlStr.Append("			<tr height=24 style='height: 13.0pt'>                                                                                                               \n");
            htmlStr.Append("				<td height=24 class=xl8227974 colspan=2 style='height: 13.0pt'>" + dt.Rows[0]["convert_date"] + "</td>                                                                            \n");
            htmlStr.Append("				<td class=xl6627974>&nbsp;</td>                                                                                                                 \n");
            htmlStr.Append("				<td class=xl6627974>&nbsp;</td>                                                                                                                 \n");
            htmlStr.Append("				<td class=xl6627974>&nbsp;</td>                                                                                                                 \n");
            htmlStr.Append("				<td class=xl6627974>&nbsp;</td>                                                                                                                 \n");
