...
namespace EInvoice.Company
{
    public class Genuwin_New
    {
        public static string View(string tei_einvoice_m_pk, string tei_company_pk, string dbName)
        {
            ...
            string _conString = "Data Source={0};User Id={1};Password={2};8Unicode=true";
            ...
            htmlStr.Append("  <td class=xl67 width=80 style='width:75pt'><font class='font6'><b>" + dt.Rows[0]["Seller_Name_new"] + "  </font><font class='font8'> <i>(" + dt.Rows[0]["Seller_Fname_new"] + " )</i></b></font></td>                             \n");
            ...
            htmlStr.Append("  class='font14'>) :</font><font class='font65'>" + dt.Rows[0]["Seller_TaxCode_new"] + " </font></td>                                                                                                         \n");
            ...
            htmlStr.Append("  ch&#7881; <i>(Address)</i> : " + dt.Rows[0]["seller_address_new"] + " </td>                                                                                                                                 \n");
            htmlStr.Append("  <td class=xl76>&nbsp;</td>                                                                                                                                                                \n");
            htmlStr.Append(" </tr>                                                                                                                                                                                      \n");
            ...
            htmlStr.Append("  tho&#7841;i(<font class='font22'>Tel)</font> :" + dt.Rows[0]["seller_tel_new"] + " - Fax:" + dt.Rows[0]["seller_fax_new"] + " - Website: " + dt.Rows[0]["seller_website"] + "</td>                                                          \n");
            htmlStr.Append("  <td class=xl76>&nbsp;</td>                                                                                                                                                                \n");
            htmlStr.Append(" </tr>                                                                                                                                                                                      \n");
            htmlStr.Append(" <tr height=21 style='height:19.6875pt'>                                                                                                                                                      \n");
            htmlStr.Append("  <td height=21 class=xl71 style='height:19.6875pt'>&nbsp;</td>                                                                                                                               \n");
            ...
            htmlStr.Append("  width=891 height=347 src='D:/webproject/e-invoice-ws/02.Web/EInvoice/img/ .png' v:shapes='Rectangle_x0020_1'></span><![endif]>                                                        \n");
            htmlStr.Append("  </td>                                                                                                                                                                                     \n");
            htmlStr.Append(" </tr>                                                                                                                                                                                      \n");
            htmlStr.Append("                                                                                                                                                                                            \n");
            htmlStr.Append("                                                                                                                                                                                            \n");
