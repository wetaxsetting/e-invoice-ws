...
namespace EInvoice.Company
{
    public class DeaYoung
    {
        public static string View(string tei_einvoice_m_pk, string tei_company_pk, string dbName)
        {
            ...
            */
            string read_prive = "", read_en = "", read_amount = "", amout_vat = "", amount_vie = "", vat_amount_vie = "", total_amount_vie = "";
            ...
            //     //amount_vie = dt.Rows[0]["total_tr_amt_vie"].ToString();
            //     //vat_amount_vie = dt.Rows[0]["total_tr_amt_vie"].ToString();
            //     //total_amount_vie = dt.Rows[0]["total_tr_amt_vie"].ToString();
       ...
       ;
            ...
            htmlStr.Append("			</td>                                                                                                                                                                                       \n");
            htmlStr.Append("			<td colspan=2 class=xl1867651 style='border-left: none'>&nbsp;" + dt.Rows[0]["NETAMOUNT_DISPLAY"] + "</td>                                                                                                           \n");
            ...
            htmlStr.Append("				class='font87651'>) :</font>                                                                                                                                                            \n");
            htmlStr.Append("			</td>                                                                                                                                                                                       \n");
            htmlStr.Append("			<td colspan=2 class=xl1867651 style='border-left: none'>&nbsp;" + dt.Rows[0]["VATAMOUNT_DISPLAY"] + "</td>                                                                                                         \n");
            ...
            htmlStr.Append("			</td>                                                                                                                                                                                       \n");
            htmlStr.Append("			<td colspan=2 class=xl1867651 style='border-left: none'>&nbsp;" + dt.Rows[0]["TOTALAMOUNT_DISPLAY"] + "</td>                                                                                                  \n");
