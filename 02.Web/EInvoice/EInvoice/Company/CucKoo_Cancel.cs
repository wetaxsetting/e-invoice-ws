        ...
        public static string View(string tei_einvoice_m_pk, string tei_company_pk, string dbName)
        {
            ...
            */
            ...
            for (int k = 0; k < v_countNumberOfPages; k++)
            {
                ...
                htmlStr.Append("style='mso-ignore: vglayout; position: absolute; z-index: 1; margin-left: -95px; margin-top: 24px; width: 647px; height: 702px'><img" + " \n");
