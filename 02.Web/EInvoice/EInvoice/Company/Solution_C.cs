...
namespace EInvoice.Company
{
    public class Solution_C
    {
        public static string View(string tei_einvoice_m_pk, string tei_company_pk, string dbName)
        {
            ...
            htmlStr.Append("  <td class=xl67 width=80 style='width:75pt'><font class='font6'><b>" + dt.Rows[0]["COMPANY_NM_86"] + "  </font><font class='font8'> <i>(" + dt.Rows[0]["COMPANY_LNM_87"] + " )</i></b></font></td>                  \n");
            ...
            htmlStr.Append(" <tr height=20 style='mso-height-source:userset;height:18.75pt'>                                                                                                                  \n");
            htmlStr.Append("  <td height=20 class=xl71 style='height:18.75pt;color:#003366;'>&nbsp;" + dt.Rows[0]["convert_date"] + "</td>                                                                                                                     \n");
            htmlStr.Append("  <td class=xl169></td>                                                                                                                                                          \n");
