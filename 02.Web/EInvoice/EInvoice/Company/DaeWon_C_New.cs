    ...
    public class DaeWon_C_New
    {
        public static string View(string tei_einvoice_m_pk, string tei_company_pk, string dbName)
        {
            ...
            */
            ...
            double v_totalHeightLastPage = 393.5;// 258.5;
            ...
            for (int k = 0; k < v_countNumberOfPages; k++)
            {
                ...
                htmlStr.Append("			</tr>                                                                                                                                                                                                        \n");
                htmlStr.Append("			<tr height=21 style='height: 19.5pt'>                                                                                                                                                                        \n");
                htmlStr.Append("				<td colspan=7 height=21 class=xl11725524 style='height: 19.5pt'>(HÓA &#272;&#416;N CHUY&#7874;N &#272;&#7892;I T&#7914; HÓA &#272;&#416;N &#272;I&#7878;N T&#7916;)                                                                                                                                         \n");
                htmlStr.Append("				</td>                                                                                                                                                                                                    \n");
            ...
            htmlStr.Append("    				<td colspan=3 height=21 class=xl11925524 style='height: 15.6pt'>Converter</td>                                                               \n");
            htmlStr.Append("    				<td colspan=3 class=xl12125524>Ng&#432;&#7901;i mua hàng / <font                                                               \n");
            htmlStr.Append("    					class='font625524'>Customer</font></td>                                                               \n");
            htmlStr.Append("    				<td colspan=4 class=xl12425524 style='border-top: none;'>Th&#7911; tr&#432;&#7903;ng                                                               \n");
            htmlStr.Append("    					&#273;&#417;n v&#7883; /<font class='font625524'> Manager</font>                                                               \n");
            htmlStr.Append("    				</td>                                                               \n");
            htmlStr.Append("    				<td class=xl7125524>&nbsp;</td>                                                               \n");
            htmlStr.Append("    			</tr>                                                               \n");
            htmlStr.Append("    			<tr height=21 style='height: 15.6pt'>                                                               \n");
            htmlStr.Append("    				<td colspan=3 height=21 class=xl12225524 style='height: 15.6pt'>(Ký,                                                               \n");
            htmlStr.Append("    					ghi rõ h&#7885; tên)</td>                                                               \n");
            htmlStr.Append("    				<td colspan=3 class=xl12425524>Ký, ghi rõ h&#7885; tên<span                                                               \n");
            ...
            htmlStr.Append("    			</tr>                                                               \n");
            htmlStr.Append("    			<tr height=21 style='height: 15.6pt'>                                                               \n");
            htmlStr.Append("    				<td colspan=3 height=21 class=xl12825524 style='height: 15.6pt'>(Sign                                                               \n");
            htmlStr.Append("    					&amp; full name)</td>                                                               \n");
            htmlStr.Append("    				<td colspan=3 class=xl12725524>(Signature, full name)</td>                                                               \n");
            ...
            htmlStr.Append("		</tr>                                                                                                                                                                                                            \n");
            htmlStr.Append("		<tr height=20 style='mso-height-source: userset; height: 23.0pt'>                                                                                                                                                \n");
            htmlStr.Append("			<td height=20 class=xl7725525 style='height: 23.0pt'colspan=3>&nbsp;" + dt.Rows[0]["convert_name"] + "</td>                                                                                                                                             \n");
            htmlStr.Append("			<td class=xl6325525 colspan=2>" + dt.Rows[0]["attribute_02"] + " </td>                                                                                                                                                           \n");
            htmlStr.Append("			<td class=xl6325524></td>                                                                                                                                                                                    \n");
