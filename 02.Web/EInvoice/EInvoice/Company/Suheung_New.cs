...
namespace EInvoice.Company
{
    public class Suheung_New
    {
        public static string View(string tei_einvoice_m_pk, string tei_company_pk, string dbName)
        {
            ...
            double v_totalHeightLastPage = 278.5;// 323.5;// 258.5;

            double v_totalHeightPage = 580;//   540;

            for (int k = 0; k < v_countNumberOfPages; k++)
            {
                v_totalHeightPage = 550;// 540;
                ...
                htmlStr.Append("  <td style='border-top:none;border-bottom:none;border-left:none;border-right:none' class=xl7315939>&nbsp;</td>                                                                                                                  \n");
                htmlStr.Append("  <td style='border-top:none;border-bottom:none;border-left:none;border-right:none' class=xl7315939>&nbsp;</td>                                                                                                                  \n");
                htmlStr.Append("  <td style='border-top:none;border-bottom:none;border-left:none;border-right:none' colspan=7 class=xl18915939><span                                                                                                              \n");
                ...
                htmlStr.Append(" <tr height=24 style='mso-height-source:userset;height:22.5pt;border-top:none;border-left:none;border-right:none;border-bottom:none'>                                                                                    \n");
                htmlStr.Append("  <td height=24  class=xl8415939 style='height:22.5pt;border-top:none;border-left:none;border-right:none;border-bottom:none'>&nbsp;</td>                                                                                  \n");
                htmlStr.Append("  <td class=xl8715939 colspan=5 style='height:22.5pt;border-top:none;border-left:none;border-right:none;border-bottom:none'>Mã số thuế (<font                                                                                         \n");
                ...
                htmlStr.Append("  <td class=xl8715939 colspan=8 style='height:22.5pt;border-top:none;border-left:none;border-right:none;border-bottom:none'>Hình thức thanh toán (<font                                                                                                 \n");
                htmlStr.Append("  class='font1015939'>Payment term</font><font class='font615939'>):  </font>" + dt.Rows[0]["PaymentMethodCK"] + "</td>                                                                 \n");
                htmlStr.Append("  <td class=xl8115939 style='height:22.5pt;border-top:none;border-left:none;border-right:none;border-bottom:none'>&nbsp;</td>                                                                                                                  \n");
                htmlStr.Append(" </tr>                                                                                                                                             \n");
                htmlStr.Append(" <tr height=24 style='mso-height-source:userset;height:22.5pt;border-top:none;border-left:none;border-right:none;border-bottom:none'>                                                                                    \n");
                htmlStr.Append("  <td height=24  class=xl8415939 style='height:22.5pt;border-top:none;border-left:none;border-right:none;border-bottom:none'>&nbsp;</td>                                                                                  \n");
                htmlStr.Append("  <td class=xl8715939 colspan=5 style='height:22.5pt;border-top:none;border-left:none;border-right:none;border-bottom:none'>Loại tiền tệ (<font                                                                                         \n");
                ...
                htmlStr.Append("  <td class=xl8715939 colspan=8 style='height:22.5pt;border-top:none;border-left:none;border-right:none;border-bottom:none'>Tỷ giá (<font                                                                                                 \n");
                htmlStr.Append("  class='font1015939'>Exchagne rate</font><font class='font615939'>):  </font>" + dt.Rows[0]["tr_rate_88"] + "</td>                                                                 \n");
                htmlStr.Append("  <td class=xl8115939 style='height:22.5pt;border-top:none;border-left:none;border-right:none;border-bottom:none'>&nbsp;</td>                                                                                                                  \n");
                htmlStr.Append(" </tr>                                                                                                                                             \n");
                ...
                htmlStr.Append("  style='mso-spacerun:yes'> </span></font>" + dt.Rows[0]["DECLARE_NO"] + "</td>                                                                                                    \n");
                ...
                v_rowHeightLast = "25.0pt";// "23.5pt";
                v_rowHeightLastNumber = 25;// 23.5;
                ...
                for (int dtR = 0; dtR < page[k]; dtR++)
                {
                    ...
                    { //dong dau
                        ...
                        else
                        {
                            htmlStr.Append(" 	<td colspan=2 class=xl16615939  height=24 width=39 style='border-right:1pt solid black;border-bottom:none             \n");
                            htmlStr.Append(" 	  height:22.5pt;width:" + (k == v_countNumberOfPages - 1 ? v_rowHeightLast : v_rowHeight).ToString() + "' align=left valign=top><![if !vml]><span style='mso-ignore:vglayout;                                                                   \n");
                            htmlStr.Append(" 	  position:absolute;z-index:3;margin-left:60px;margin-top:85px;width:739px;           \n");
                            htmlStr.Append(" 	  height:116px'><img width=739 height=116                                                                 \n");
                            htmlStr.Append(" 	  src='D:/webproject/e-invoice-ws/02.Web/EInvoice/img/Suheung_2_20230512.png'             \n");
                            htmlStr.Append(" 	  v:shapes='Picture_x0020_14'></span><![endif]><span style='mso-ignore:vglayout2'>                                                                    \n");
                            htmlStr.Append(" 	  <table cellpadding=0 cellspacing=0>             \n");
                            htmlStr.Append(" 	   <tr>                                                                     \n");
                            htmlStr.Append(" 		<td height=22  style='height:21.375pt‬;border-bottom:none;border-top:none'>&nbsp;&nbsp;&nbsp;&nbsp;" + dt_d.Rows[v_index][7] + "</td>             \n");
                            htmlStr.Append(" 	   </tr>             \n");
                            htmlStr.Append(" 	  </table>             \n");
                            htmlStr.Append(" 	  </span></td>             \n");
                    ...
                    else if (dtR == page[k] - 1)//dong cuoi moi trang
                    {
                        ...
                        else // trang cuoi
                        {
                            ...
                            {
                                htmlStr.Append(" <tr class=xl8715939 height=24 style='mso-height-source:userset;height:" + (k == v_countNumberOfPages - 1 ? v_rowHeightLast : v_rowHeight).ToString() + "'>                                                                    \n");
                                htmlStr.Append("  <td colspan=2 height=24 class=xl16615939 width=39 style='border-right:1pt solid black;                                                          \n");
                                htmlStr.Append("  height:" + (k == v_countNumberOfPages - 1 ? v_rowHeightLast : v_rowHeight).ToString() + ";width:29pt'>&nbsp;" + dt_d.Rows[v_index][7] + "</td>                                                                                                            \n");
                                htmlStr.Append("  <td colspan=4 class=xl15615939 width=264 style='width:198pt;border-right:1pt solid black;border-top:none;border-bottom:none '>&nbsp;" + dt_d.Rows[v_index]["ITEM_NAME"].ToString() + "</td>                                                                         \n");
                                htmlStr.Append("  <td class=xl12115939 width=77 style='width:72.5‬pt;border-right:1pt solid black; '>&nbsp;" + dt_d.Rows[v_index][1] + "</td>                                                                                     \n");
                                htmlStr.Append("  <td class=xl12215939 width=78 style='border-left:none;width:72.5‬pt;border-right:none; '>&nbsp;" + dt_d.Rows[v_index][2] + "</td>                                                                    \n");
                                htmlStr.Append("  <td class=xl12315939 width=6 style='width:5pt;border-right:1pt solid black; '>&nbsp;</td>                                                                                       \n");
                                htmlStr.Append("  <td colspan=2 class=xl11615939 style='border-left:none;border-right:none; '>&nbsp;" + dt_d.Rows[v_index][3] + "</td>                                                                              \n");
                                htmlStr.Append("  <td class=xl12415939 width=6 style='width:5pt;border-right:1pt solid black; '>&nbsp;</td>                                                                                       \n");
                                htmlStr.Append("  <td colspan=2 class=xl11615939 style='border-left:none;border-right:none; '>&nbsp;" + dt_d.Rows[v_index][4] + "</td>                                                                              \n");
                                htmlStr.Append("  <td class=xl12515939 width=12 style='width:9pt;border-right:1pt solid black; '>&nbsp;</td>                                                                                      \n");
                                htmlStr.Append(" </tr>                                                                                                                                             \n");
                            }
            ...
            htmlStr.Append("  <td colspan=2 class=xl17615939 style='height:16.95pt;border-top:1pt solid black;'>&nbsp;" + amount_net + "</td>                                                                                                       \n");
            ...
            htmlStr.Append("  class='font815939'>):</font></td>                                                                                                                \n");
            htmlStr.Append("  <td colspan=2 class=xl18015939 style='height:16.95pt;border-top:none;border-bottom:none;border-left:none;border-right:none'>&nbsp;" + amount_vat + "</td>                                                                                                       \n");
            ...
            htmlStr.Append("  <td colspan=5 class=xl17120842  style='height:16.95pt;border-top:none;border-left:none;border-right:none'>Tổng (<font																														 \n");
            htmlStr.Append("				  class='font915939'>Amount VND</font><font class='font820842'>):<span                                                                           \n");
            htmlStr.Append("				  style='mso-spacerun:yes'>       </span>"+ amount_trans + "</font></td>                                                                        \n"); htmlStr.Append("  <td colspan=6 class=xl17815939 style='border-top:none;border-bottom:1pt solid black;border-left:none;border-right:1pt solid black;'>T&#7893;ng c&#7897;ng ti&#7873;n thành toán (<font                                                                \n");
            htmlStr.Append("  class='font1015939'>Total of payment</font><font class='font815939'>):</font></td>                                                               \n");
            htmlStr.Append("  <td colspan=2 class=xl18015939  style='width:95pt;border-top:none;border-bottom:1pt solid black;border-left:none;border-right:none'>&nbsp;" + amount_total + "</td>                                                                                                       \n");
            ...
            htmlStr.Append(" <tr class=xl9120842 height=21 style='mso-height-source:userset;height:19.6875‬pt'>    \n");
            htmlStr.Append("   <td height=21 class=xl14120842 style='height:19.6875‬pt;border-top:none;border-bottom:none;border-left:none;border-right:none'>&nbsp;</td>                                                     \n");
            htmlStr.Append("   <td colspan=3 class=xl18320842 width=263 style='font-weight:700; width:198pt;text-align:center;border-top:none;border-bottom:none;border-left:none;border-right:none'>Người                                                     \n");
            htmlStr.Append("   mua hàng (Buyer)</td>                                                     \n");
            htmlStr.Append("   <td colspan=5 class=xl18420842 width=195 style='width:145pt;border-top:none;border-bottom:none;border-left:none;border-right:none'></td>                                                     \n");
            htmlStr.Append("   <td colspan=5 class=xl17620842 width=233 style='font-weight:700;width:175pt;text-align:center;border-top:none;border-bottom:none;border-left:none;border-right:none'>Người                                                     \n");
            htmlStr.Append("   bán hàng (Seller)</td>                                                     \n");
            htmlStr.Append("   <td class=xl14020842 width=12 style='width:9pt;border-right:.5pt solid windowtext;border-top:none;border-bottom:none;border-left:none;border-right:none'>&nbsp;</td>                                                     \n");
            htmlStr.Append("  </tr>                                                     \n");
            htmlStr.Append("  <tr class=xl8120842 height=18 style='mso-height-source:userset;height:17.5pt;border-top:none;border-bottom:none;border-left:none;border-right:none'>                 \n");
            htmlStr.Append("   <td height=18 class=xl14220842 style='height:17.5pt;border-top:none;border-bottom:none;border-left:none;border-right:none'>&nbsp;</td>                 \n");
            htmlStr.Append("   <td colspan=3 class=xl18520842 width=222 style='width:167pt;text-align:center;border-top:none;border-bottom:none;border-left:none;border-right:none'>(Ký, ghi rõ                 \n");
            ...
            htmlStr.Append("   <td colspan=4 class=xl18520842 width=195 style='width:145pt;border-top:none;border-bottom:none;border-left:none;border-right:none'></td>                 \n");
            htmlStr.Append("   <td colspan=5 class=xl14320842 width=233 style='width:175pt;text-align:center;border-top:none;border-bottom:none;border-left:none;border-right:none'>(Ký, Đóng                 \n");
            htmlStr.Append("   dấu, ghi rõ họ tên)</td>                 \n");
            htmlStr.Append("   <td class=xl14420842 width=12 style='width:9pt;border-right:.5pt solid windowtext;border-top:none;border-bottom:none;border-left:none;border-right:none'>&nbsp;</td>                 \n");
            htmlStr.Append("  </tr>                 \n");
            htmlStr.Append("  <tr class=xl14820842 height=20 style='mso-height-source:userset;height:19.3125‬pt;border-top:none;border-bottom:none;border-left:none;border-right:none'>                 \n");
            htmlStr.Append("   <td height=20 class=xl14520842 style='height:19.3125‬pt;border-top:none;border-bottom:none;border-left:none;border-right:none;   '>&nbsp;</td>                 \n");
            htmlStr.Append("   <td colspan=3 class=xl14620842 width=222 style='width:167pt;text-align:center;border-top:none;border-bottom:none;border-left:none;border-right:none'>(Signature &amp;                 \n");
            ...
            htmlStr.Append("   <td colspan=3 class=xl18620842 width=195 style='width:145pt;border-top:none;border-bottom:none;border-left:none;border-right:none'></td>                 \n");
            htmlStr.Append("   <td colspan=1 class=xl18620842 width=195 style='width:145pt;border-top:none;border-bottom:none;border-left:none;border-right:none'></td>                 \n");
            htmlStr.Append("   <td colspan=5 class=xl14620842 width=233 style='width:175pt;text-align:center;border-top:none;border-bottom:none;border-left:none;border-right:none'>(Signature,                 \n");
            htmlStr.Append("   stamp &amp; full name)</td>                 \n");
            htmlStr.Append("   <td class=xl14720842 width=12 style='width:9pt;border-right:.5pt solid windowtext;border-top:none;border-bottom:none;border-left:none;border-right:none'>&nbsp;</td>                 \n");
            htmlStr.Append("  </tr>                 \n");
            ...
            htmlStr.Append("  <td class=xl15215939 style='border-top:none;border-bottom:none;border-left:none;border-right:none'></td>                                                                                                                     \n");
            htmlStr.Append("  <td class=xl8215939 width=127 style='width:95pt;border-top:none;border-bottom:none;border-left:none;border-right:none'>&nbsp;</td>                                                                                     \n");
            htmlStr.Append("  <td class=xl8215939 width=62 style='width:47pt;border-top:none;border-bottom:none;border-left:none;border-right:none'>&nbsp;</td>                                                                                      \n");
            htmlStr.Append("  <td class=xl8215939 width=41 style='width:31pt;border-top:none;border-bottom:none;border-left:none;border-right:none'>&nbsp;</td>                                                                                      \n");
            htmlStr.Append("  <td class=xl8215939 width=34 style='width:31.25pt;border-top:none;border-bottom:none;border-left:none;border-right:none'>&nbsp;</td>                                                                                      \n");
