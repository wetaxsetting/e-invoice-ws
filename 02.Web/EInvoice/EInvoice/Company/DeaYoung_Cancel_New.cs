...
{
    public class DeaYoung_Cancel_New
    {
        public static string View(string tei_einvoice_m_pk, string tei_company_pk, string dbName)
        {
            ...
            htmlStr.Append("	mso-ignore: padding;                                                                                                                                                                                \n");
            htmlStr.Append("	color: windowtext;                                                                                                                                                                                  \n");
            htmlStr.Append("	font-size: 12.56pt;                                                                                                                                                                                   \n");
            htmlStr.Append("	font-weight: 700;                                                                                                                                                                                   \n");
            htmlStr.Append("	font-style: normal;                                                                                                                                                                                 \n");
            htmlStr.Append("	text-decoration: none;                                                                                                                                                                              \n");
            htmlStr.Append("	font-family: 'Times New Roman', serif;                                                                                                                                                              \n");
            ...
            for (int k = 0; k <= page_num; k++)
            {
               ...
               */
                ...
                {
                    htmlStr.Append("		<td class=xl757651 colspan=5><span																																				\n");
                    htmlStr.Append("				style='mso-ignore: vglayout; position: absolute; z-index: 1; margin-left: -2px; margin-top: 0px; width: 883px; height: 877px'><img                                      \n");
                    htmlStr.Append("					width=883 height=877                                                                                                                                                \n");
                ...
                {
                    htmlStr.Append("							H&#7885; tên ng&#432;&#7901;i mua hàng (<font                                                                                 \n");
                    htmlStr.Append("								 class='font1012067'>Customer's name</font><font class='font712067'>):</font>                                                                      \n");
                ...
                else if (dt.Rows[0]["ETAX_STATUS"].ToString() == "3")
                {
                    htmlStr.Append("				<td colspan=2 class=xl1637651 style='border-right: .5pt solid black'>																													  \n");
                    htmlStr.Append("				<![if !vml]><span                                                                                                                                                                         \n");
                    htmlStr.Append("					style='mso-ignore: vglayout; position: absolute; z-index: 2; margin-left: 10px; margin-top: 300px; width: 410px; height: 87px'><img                                                    \n");
                ...
                if (k == (page_num))
                {
                    ...
                    htmlStr.Append("			style='mso-height-source: userset; height: 18.0pt'>                                                                                                                                         \n");
                    htmlStr.Append("			<td height=24 class=xl947651 style='height: 18.0pt'>&nbsp;</td>                                                                                                                             \n");
                    ...
                    htmlStr.Append("			style='mso-height-source: userset; height: 13.95pt'>                                                                                                                                        \n");
                    htmlStr.Append("			<td height=20 class=xl977651 style='height: 13.95pt'>&nbsp;</td>                                                                                                                            \n");
                    ...
                    htmlStr.Append("		</tr>                                                                                                                                                                                           \n");
                    htmlStr.Append("		<tr height=21 style='height: 18.5pt'>                                                                                                                                                           \n");
                    htmlStr.Append("			<td height=21 class=xl1377651 style='height: 18.5pt'>&nbsp;</td>                                                                                                                            \n");
                    htmlStr.Append("			<td class=xl657651>&nbsp;</td>                                                                                                                                                              \n");
                    htmlStr.Append("			<td class=xl657651>&nbsp;</td>                                                                                                                                                              \n");
                    htmlStr.Append("			<td class=xl657651>&nbsp;</td>                                                                                                                                                              \n");
                    htmlStr.Append("			<td class=xl717651 width=41 style='width: 36.81pt'>&nbsp;</td>                                                                                                                              \n");
                    ...
                    htmlStr.Append("			<td height=20 class=xl1377651 style='height: 15.0pt'>&nbsp;</td>                                                                                                                            \n");
