    ...
    public class HiKnit
    {
        public static string View(string tei_einvoice_m_pk, string tei_company_pk, string dbName)
        {
            ...
            if (dt.Rows[0]["CurrencyCodeUSD"].ToString() == "VND")
            {
                ...
                read_en = ConvertToWords(read_amount.Trim(), "VND");
                if (read_en.Length > 0)
                {
                    read_en = read_en.Substring(0, 2) + read_en.Substring(2).ToLower().Replace("viet nam dong", "Viet Nam Dong") + ".";
                }
            ...
            else
            {
                ...
                read_en = ConvertToWords(read_amount.Trim(), "USD");
                if(read_en.Length > 0)
                {
           ...
           htmlStr.Append("				    </tr>                                                                                                                        \n");
            ...
            htmlStr.Append("							src='E:/Tomcat/webapps/e-invoice/assets/images/HiKnit.png'                                                       \n");
            ...
            htmlStr.Append("						style='border-right: 2.0pt double black'>M&#7851;u s&#7889;/<font                                                    \n");
            htmlStr.Append("						class='font1922200'>Form</font><font class='font1822200'>: " + dt.Rows[0]["templateCode"] + "</font></td>                                \n");
            htmlStr.Append("				</tr>                                                                                                                        \n");
            ...
            htmlStr.Append("							" + dt.Rows[0]["InvoiceSerialNo"] + "</font></td>                                                                                     \n");
            ...
            htmlStr.Append("						style='border-right: 2.0pt double black'>&nbsp;" + dt.Rows[0]["Attribute_01"] + "</td>                                         \n");
            htmlStr.Append("				</tr>                                                                                                                        \n");
            htmlStr.Append("				<tr height=22 style='mso-height-source: userset; height: 21.0pt'>                                                           \n");
            htmlStr.Append("					<td height=22 class=xl9722200 colspan=2 style='height: 21.0pt'><span                                                    \n");
            ...
            htmlStr.Append("				</tr>                                                                                                                        \n");
       		...
       		{                                                                                                        
       			...
       			{                                                                                                
                    ...
                    htmlStr.Append("				<tr height=24 style='mso-height-source: userset; height: 21.0pt'>                                                           \n");
                    htmlStr.Append("					<td height=24 class=xl8922200 style='height: 21.0pt'>&nbsp;" + dt_d.Rows[dtR][7] + "</td>                                           \n");
                    htmlStr.Append("					<td colspan=8 class=xl14522200 width=424                                                                                 \n");
                    htmlStr.Append("						style='border-right: 1pt solid black; border-left: none; width: 318pt;'>&nbsp;" + dt_d.Rows[dtR][0] + "</td>                    \n");
                    htmlStr.Append("					<td colspan=2 class=xl16322200 width=49                                                                                  \n");
                    htmlStr.Append("						style='border-left: none; width: 37pt'>&nbsp;" + dt_d.Rows[dtR][1] + "</td>                                                      \n");
                    htmlStr.Append("					<td colspan=2 class=xl15022200 width=79 style='width: 60pt'>" + dt_d.Rows[dtR][2] + "&nbsp;</td>                                     \n");
                    htmlStr.Append("					<td colspan=2 class=xl16522200 width=87                                                                                  \n");
                    htmlStr.Append("						style='border-right: 1pt solid black; width: 65pt'>" + dt_d.Rows[dtR][3] + "&nbsp;</td>                                         \n");
                    htmlStr.Append("					<td colspan=2 class=xl16722200 width=123                                                                                 \n");
                    htmlStr.Append("						style='border-right: 2.0pt double black; width: 92pt'>" + dt_d.Rows[dtR][4] + "&nbsp;</td>                                       \n");
                    htmlStr.Append("				</tr>                                                                                                                        \n");
                    ...
                    htmlStr.Append("						style='height: 22.0pt; border-top: none;border-bottom:none;'>&nbsp;" + dt_d.Rows[dtR][7] + "</td>                                                   \n");
                    htmlStr.Append("					<td colspan=8 class=xl14522200 width=424                                                                                 \n");
                    htmlStr.Append("						style='border-right: 1pt solid black; border-left: none; width: 318pt;border-bottom:none;'>&nbsp;" + dt_d.Rows[dtR][0] + "</td>                     \n");
                    htmlStr.Append("					<td colspan=2 class=xl14822200 width=49                                                                                  \n");
                    htmlStr.Append("						style='border-right: 1pt solid black; border-left: none; width: 37pt;border-bottom:none;'>&nbsp;" + dt_d.Rows[dtR][1] + "</td>                      \n");
                    htmlStr.Append("					<td colspan=2 class=xl15022200 width=79                                                                                  \n");
                    htmlStr.Append("						style='border-left: none; width: 60pt;border-bottom:none;'>" + dt_d.Rows[dtR][2] + "&nbsp;</td>                                                      \n");
                    htmlStr.Append("					<td colspan=2 class=xl15522200 width=87                                                                                  \n");
                    htmlStr.Append("						style='border-right: 1pt solid black; width: 65pt;border-bottom:none;'>" + dt_d.Rows[dtR][3] + "&nbsp;</td>                                         \n");
                    htmlStr.Append("					<td colspan=2 class=xl15722200 width=123                                                                                 \n");
                    htmlStr.Append("						style='border-right: 2.0pt double black; border-left: none; width: 92pt;border-bottom:none;'>&nbsp;" + dt_d.Rows[dtR][4] + "&nbsp;</td>                    \n");
                    htmlStr.Append("				</tr>                                                                                                                        \n");
            ...
            htmlStr.Append("				<tr height=24 style='mso-height-source: userset; height: 21.0pt'>                                                           \n");
            htmlStr.Append("					<td height=24 class=xl8922200                                                                                            \n");
            htmlStr.Append("						style='height: 22.0pt; border-top: none'>&nbsp;" + dt_d.Rows[dtR][7] + "</td>                                                   \n");
            htmlStr.Append("					<td colspan=8 class=xl14522200 width=424                                                                                 \n");
            htmlStr.Append("						style='border-right: 1pt solid black; border-left: none; width: 318pt'>&nbsp;" + dt_d.Rows[dtR][0] + "</td>                     \n");
            htmlStr.Append("					<td colspan=2 class=xl14822200 width=49                                                                                  \n");
            htmlStr.Append("						style='border-right: 1pt solid black; border-left: none; width: 37pt'>&nbsp;" + dt_d.Rows[dtR][1] + "</td>                      \n");
            htmlStr.Append("					<td colspan=2 class=xl15022200 width=79                                                                                  \n");
            htmlStr.Append("						style='border-left: none; width: 60pt'>" + dt_d.Rows[dtR][2] + "&nbsp;</td>                                                      \n");
            ...
            htmlStr.Append("				<tr height=24 style='mso-height-source: userset; height: 21.0pt'>                                                           \n");
            htmlStr.Append("					<td height=24 class=xl8922200                                                                                            \n");
            htmlStr.Append("						style='height: 22.0pt; border-top: none;border-bottom:none;'>&nbsp;</td>                                                                \n");
            htmlStr.Append("					<td colspan=8 class=xl14522200 width=424                                                                                 \n");
            htmlStr.Append("						style='border-right: 1pt solid black; border-left: none; width: 318pt;border-bottom:none;'>&nbsp;</td>                                  \n");
            htmlStr.Append("					<td colspan=2 class=xl14822200 width=49                                                                                  \n");
            htmlStr.Append("						style='border-right: 1pt solid black; border-left: none; width: 37pt;border-bottom:none;'>&nbsp;</td>                                   \n");
            htmlStr.Append("					<td colspan=2 class=xl15022200 width=79                                                                                  \n");
            htmlStr.Append("						style='border-left: none; width: 60pt;border-bottom:none;'>&nbsp;</td>                                                                   \n");
            htmlStr.Append("					<td colspan=2 class=xl15522200 width=87                                                                                  \n");
            htmlStr.Append("						style='border-right: 1pt solid black; width: 65pt;border-bottom:none;'>&nbsp;</td>                                                      \n");
            htmlStr.Append("					<td colspan=2 class=xl15722200 width=123                                                                                 \n");
            ...
            htmlStr.Append("				<tr height=24 style='mso-height-source: userset; height: 21.0pt'>                                                           \n");
            htmlStr.Append("					<td height=24 class=xl8922200                                                                                            \n");
            htmlStr.Append("						style='height: 22.0pt; border-top: none'>&nbsp;</td>                                                                \n");
            ...
            htmlStr.Append("					<td class=xl11622200>&nbsp;" + dt.Rows[0]["exchangerate_no"] + "</td>                                                                        \n");
            htmlStr.Append("					<td colspan=3 class=xl11622200>&nbsp;</td>                                                                               \n");
            htmlStr.Append("					<td class=xl11722200>&nbsp;" + dt.Rows[0]["total_tr_amt"] + "</td>                                                                          \n");
            ...
            htmlStr.Append("					</td>                                                                                                                    \n");
            htmlStr.Append("					<td colspan=2 class=xl12722200                                                                                           \n");
            htmlStr.Append("						style='border-right: 2.0pt double black; border-left: none'>" + dt.Rows[0]["total_tr_amt_vie"] + "&nbsp;</td>                               \n");
            htmlStr.Append("				</tr>                                                                                                                        \n");
            htmlStr.Append("				<tr class=xl11822200 height=26                                                                                               \n");
            htmlStr.Append("					style='mso-height-source: userset; height: 19.95pt'>                                                                     \n");
            htmlStr.Append("					<td colspan=2 height=26 class=xl12522200 style='height: 19.95pt'><span                                                   \n");
            ...
            htmlStr.Append("					<td colspan=2 class=xl12722200                                                                                           \n");
            htmlStr.Append("						style='border-right: 2.0pt double black; border-left: none;'>" + dt.Rows[0]["vat_tr_amt_vie_display"] + "&nbsp;</td>                              \n");
            htmlStr.Append("				</tr>                                                                                                                        \n");
            htmlStr.Append("				<tr class=xl11822200 height=26                                                                                               \n");
            htmlStr.Append("					style='mso-height-source: userset; height: 19.95pt'>                                                                     \n");
            ...
            htmlStr.Append("					<td colspan=2 class=xl12722200                                                                                           \n");
            htmlStr.Append("						style='border-right: 2.0pt double black; border-left: none;font-weight: 700'>" + dt.Rows[0]["totalamount_display_vie"] + "&nbsp;</td>     \n");
            htmlStr.Append("				</tr>                                                                                                                        \n");
            htmlStr.Append("				<tr height=24 style='mso-height-source: userset; height: 21.0pt'>                                                           \n");
            ...
            String xmlStr = "";
                ...
                Invoice1.AppendChild(Attribute_01);
                ...
                Invoice1.AppendChild(Attribute_02);
                ...
                Invoice1.AppendChild(Attribute_03);
                ...
                Invoice1.AppendChild(Attribute_04);
                ...
                Invoice1.AppendChild(Attribute_05);
                ...
                Invoice1.AppendChild(Attribute_06);
                ...
                Invoice1.AppendChild(Attribute_07);
                ...
                Invoice1.AppendChild(Attribute_08);
                ...
                Invoice1.AppendChild(Attribute_09);
                ...
                Invoice1.AppendChild(Attribute_10);
