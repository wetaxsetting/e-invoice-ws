    ...
    public class CucKoo_New
    {
        public static string View(string tei_einvoice_m_pk, string tei_company_pk, string dbName)
        {
            ...
            */
            ...
            for (int k = 0; k < v_countNumberOfPages; k++)
            {
                ...
                for (int dtR = 0; dtR < page[k]; dtR++)
                {
                    if (!vlongItemName && dt_d.Rows[v_index]["ITEM_NAME"].ToString().Length >= 92)
                    {
                        ...
                        v_rowHeightLastNumber = 27.5;//27.5;
            ...
            htmlStr.Append("						style='mso-height-source: userset; height: 18.1pt'>                                                                                                \n");
            htmlStr.Append("						<td height=22 class=xl11729612 style='height: 18.1pt'>&nbsp;</td>                                                                                  \n");
            ...
            htmlStr.Append("					</tr>                                                                                                                                                   \n");
            htmlStr.Append("					<tr height=21 style='height: 17.38pt'>                                                                                                                  \n");
            htmlStr.Append("						<td height=21 class=xl10429612 style='height: 17.38pt'>&nbsp;</td>                                                                                  \n");
            ...
            htmlStr.Append("						<td class=xl10629612>&nbsp;</td>                                                                                                                    \n");
            htmlStr.Append("					</tr>                                                                                                                                                   \n");
            htmlStr.Append("					<tr height=28 style='mso-height-source: userset; height: 20.05pt'>                                                                                      \n");
            htmlStr.Append("						<td height=28 class=xl10429612 style='height: 20.05pt'>&nbsp;</td>                                                                                  \n");
            htmlStr.Append("						<td class=xl6529612></td>                                                                                                                           \n");
            htmlStr.Append("						<td class=xl6529612></td>                                                                                                                           \n");
            htmlStr.Append("						<td class=xl6529612></td>                                                                                                                           \n");
            htmlStr.Append("						<td class=xl6529612></td>                                                                                                                           \n");
