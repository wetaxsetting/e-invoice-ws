        ...
        public static string View(string tei_einvoice_m_pk, string tei_company_pk, string dbName)
        {
            ...
            for (int i = 0; i < 99; i++)
            {
                ...
                for (int j = 0; j < v_count; j++)
                {
                    ...
                    else
                    {
                        ...
                        {
                            if (j == v_count - 1 && count_col_index % pos > 0 && count_col_index > pos && k < words.Count) // check dong cuoi cung cua nhieu trang
                            {
                                page_num++;
                                count_col_index = 0;
                            }
            ...
            for (int k = 0; k <= page_num; k++)
            {
                ...
                if (k == (page_num))
                {
                    ...
                    v_height_total = 250 - (count_rows) * 25 - (count_add * 25);
                    ...
                    htmlStr.Append("			<td class=xl1007651 width=6 style='width: 4.75pt'>&nbsp;</td>                                                                                                                                \n");
                    htmlStr.Append("		</tr>                                                                                                                                                                                           \n");
                    htmlStr.Append("		<tr height=16 style='mso-height-source: userset; height: 10.0pt'>                                                                                                                               \n");
                    htmlStr.Append("			<td height=16 class=xl827651 style='height: 10.0pt'>&nbsp;</td>                                                                                                                             \n");
