...
namespace EInvoice.Company
{
    public class Genuwin_C
    {
        public static string View(string tei_einvoice_m_pk, string tei_company_pk, string dbName)
        {
            ...
            htmlStr.Append("  height:87px'><img width=230 height=108 src='D:/webproject/e-invoice-ws/02.Web/EInvoice/img/genuwin.jpg'                                                                                         \n");
            ...
            htmlStr.Append("	  <td class=xl80></td>                                                                                                                                                          \n");
            htmlStr.Append("	  <td class=xl72></td>                                                                                                                                                          \n");
            htmlStr.Append("	  <td colspan=5 class=xl204>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(<font class='font29'>HÓA ĐƠN CHUYỂN ĐỔI TỪ HÓA ĐƠN ĐIỆN TỬ)</font></td>    \n");
            htmlStr.Append("	  <td class=xl70></td>                                                                                                                                                          \n");
            ...
            htmlStr.Append("  width=891 height=347 src='D:/webproject/e-invoice-ws/02.Web/EInvoice/img/genuwinbg4_pdf.png' v:shapes='Rectangle_x0020_1'></span><![endif]>                                                        \n");
            htmlStr.Append("  </td>                                                                                                                                                                                     \n");
            htmlStr.Append(" </tr>                                                                                                                                                                                      \n");
            htmlStr.Append("                                                                                                                                                                                            \n");
            htmlStr.Append("                                                                                                                                                                                            \n");
            ...
            htmlStr.Append("	   <td height=31 class=xl165 style='height:29.0625pt;border-top:.5pt solid black;'>&nbsp;</td>                                                                             \n");
            htmlStr.Append("	   <td colspan=2 class=xl186 width=191 style='width:143pt;border-top:.5pt solid black;'>Ng&#432;&#7901;i                                                                 \n");
            htmlStr.Append("	   th&#7921;c hi&#7879;n chuy&#7875;n &#273;&#7893;i (Converter)</td>                                                                                                    \n");
            htmlStr.Append("	   <td colspan=2 class=xl186 width=141 style='width:106pt;border-top:.5pt solid black;'>Ng&#432;&#7901;i mua                                                             \n");
            htmlStr.Append("	   (Buyer)</td>                                                                                                                                                          \n");
            htmlStr.Append("	   <td colspan=3 class=xl186 width=148 style='width:112pt;border-top:.5pt solid black;'></td>                                                                            \n");
            htmlStr.Append("	   <td colspan=3 class=xl187 width=218 style='width:164pt;border-top:.5pt solid black;'>Người bán                                                                        \n");
            ...
            htmlStr.Append("	   <td colspan=2 class=xl177 width=141 style='width:106pt'>Ký, ghi rõ h&#7885;                                                                                           \n");
            htmlStr.Append("	   tên</td>                                                                                                                                                              \n");
            ...
            htmlStr.Append("	   <td colspan=2 class=xl177 width=141 style='width:106pt'>(Sign &amp; full                                                                                              \n");
            htmlStr.Append("	   name)</td>                                                                                                                                                            \n");
            htmlStr.Append("	   <td colspan=3 class=xl177 width=148 style='width:112pt'></td>                                                                                                         \n");
            ...
            htmlStr.Append(" </tr>                                                                                                                                                                                      \n");
            htmlStr.Append(" <tr height=20 style='mso-height-source:userset;height:18.75‬pt'>                                                                                                                             \n");
            htmlStr.Append("  <td height=20 class=xl71 style='height:18.75‬pt;color:#003366;'>&nbsp;" + dt.Rows[0]["convert_date"] + "</td>                                                                                                                                \n");
            htmlStr.Append("  <td class=xl169></td>                                                                                                                                                                     \n");
