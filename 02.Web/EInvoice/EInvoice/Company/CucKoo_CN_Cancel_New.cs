...
{
    public class CucKoo_CN_Cancel_New
    {
        public static string View(string tei_einvoice_m_pk, string tei_company_pk, string dbName)
        {
            ...
            */
            ...
            for (int k = 0; k < v_countNumberOfPages; k++)
            {
                ...
                htmlStr.Append("						</td>                                                                                                                                               \n");
                htmlStr.Append("						<td class=xl9229612 colspan=7>                                                                                                  \n");
                ...
                htmlStr.Append("						style='mso-height-source: userset; height: 21.37pt'>                                                                                                 \n");
                htmlStr.Append("						<td height=28 class=xl10729612 style='height: 21.37pt'>&nbsp;</td>                                                                                   \n");
                htmlStr.Append("						<td class=xl6629612 colspan=4>Địa chỉ giao hàng / <font                                                                                      \n");
                htmlStr.Append("							class='font729612'>Buyer's Address</font><font class='font529612'>:<span                                                                                \n");
                htmlStr.Append("								style='mso-spacerun: yes'> </span></font></td>                                                                                              \n");
                htmlStr.Append("						<td class=xl6629612 colspan='9' style='font-size:12.0pt'>" + dt.Rows[0]["ATTRIBUTE_05"] + "</td>                                                                            \n");
                htmlStr.Append("						<td class=xl10829612>&nbsp;</td>                                                                                                                    \n");
                htmlStr.Append("					</tr>                                                                                                                                                   \n");
            ...
            htmlStr.Append("						</td>                                                                                                                                               \n");
            htmlStr.Append("						<td class=xl6529612></td>                                                                                                                           \n");
            htmlStr.Append("						<td class=xl7229612>Mã nh&#7853;n hóa &#273;&#417;n: " + dt.Rows[0]["matracuu"] + "</td>                                                                                                                           \n");
